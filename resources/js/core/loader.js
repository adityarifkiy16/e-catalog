...
function handleResponse(response) {
    ...
    if (state.firstLoad) {
        if (types.length > 0) {
            console.log('Rendering types on first load');
            ...
            console.log('Rendering products on first load');
            ...
            if (products.length > 0) {
                ...
                state.currentPage++;
                if (state.currentPage > products.last_page) state.lastPage = true;
            } else {
        ...
        console.log('Rendering products on subsequent load');
        $('#search-form').removeClass('d-none');
        $('#downloadButton').removeClass('d-none');
        $('#version-filter').removeClass('d-none');
        if (products.length > 0) {
