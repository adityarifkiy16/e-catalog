            ...
            <div class="card card-primary">
                <div class="card-body table-responsive">
                    <div class="d-flex justify-content-end align-items-center mb-3">
                        <a href="{{ route('variants.create') }}" class="btn btn-success ml-2">
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        <div class="d-flex flex-row justify-content-end align-items-end">
                            <a href="/variants/${data.id}/edit"><button type="button" class="btn btn-primary mx-2"><i class="fas fa-pencil-alt" title="Edit"></i></button></a>
                                <form action="/variants/${data.id}" style="display: inline;" class="delete-variant">
