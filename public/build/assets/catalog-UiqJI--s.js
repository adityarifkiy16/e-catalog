...
Apakah produk ini masih tersedia? Terima kasih.`;window.open(`https://wa.me/${a}?text=${encodeURIComponent(t)}`,"_blank")})}function J(){$(window).scroll(function(){$(this).scrollTop()>100?$("#btn-scroll-top").fadeIn():$("#btn-scroll-top").fadeOut()}),$("#btn-scroll-top").click(function(){return $("html, body").animate({scrollTop:0},500),!1})}function L(e,a){let t="";e.forEach(o=>{var f,y,b,v,w,C,x;const n=o.photo?`/storage/${o.photo}`:"https://via.placeholder.com/300x200?text=No+Image",c=_(o.images),i=[n,...c],l=JSON.stringify(i).replace(/"/g,"&quot;"),h=((f=o.category)==null?void 0:f.name)??"Tanpa Kategori";((y=o.category)==null?void 0:y.display_style)==="square"||a===null?t+=`
                ...
                </div>`}),$("#product-list .row").append(t)}function U(e,a,t){if(a==null)return;e.forEach(i=>{i.path&&t.add(i.path)});const o=Array.from(t),n=$("#mockup-carousel-inner"),c=$("#mockup-carousel-indicators");n.empty(),c.empty(),o.length>0?(o.length===1?($("#mockup .carousel-control-next").addClass("d-none"),$("#mockup .carousel-control-prev").addClass("d-none")):($("#mockup .carousel-control-next").removeClass("d-none"),$("#mockup .carousel-control-prev").removeClass("d-none")),o.slice(0,5).forEach((i,l)=>{n.append(`
                    ...
                    `)}),$("#mockup").removeClass("d-none")):$("#mockup").addClass("d-none")}let p=null,s=null,r=1,d=!1,u=!1;const T=new Set;function I(e){p=e.selectedJenis,s=e.category??null}function m(){if(!s||s==="null"||s===""?$("#btn-download").addClass("d-none"):$("#btn-download").removeClass("d-none"),d||u)return;d=!0,M();const e=$("#search-input").val();$.ajax({url:"/catalog",type:"GET",data:{page:r,search:e,jenis:p,category:s},success:function(a){const t=a.data.data??[];t.length>0?(L(t,p),r++,r>a.data.last_page&&(u=!0)):(r===1&&($("#mockup").addClass("d-none"),$("#product-list .row").append(`<div class="col-12"><img src="dist/img/no-data.png" alt="no-data"
                            class="img-fluid mx-auto d-block" style="max-width: 100%; height: auto; margin-top: 100px; margin-bottom: 100px;"></div>`)),u=!0),G(a),d=!1},error:function(){d=!1,console.log("Gagal memuat data.")},complete:function(){d=!1,S()}})}function G(e){var c,i;const a=((c=e.jenis)==null?void 0:c.categories)??[],t=(i=e.jenis)==null?void 0:i.name,o=e;switch(a.length===0?$("#category-container").addClass("d-none"):$("#category-container").removeClass("d-none"),U(o.category.images,p,T),t){case"PVC Board":$("#category-container, #category-modal-container").addClass("d-none");break;case"Wallboard":case"UV Board":$("#category-menu-item-label, #category-modal-item-label").html("Motif");break;case"Wallpanel":$("#category-menu-item-label, #category-modal-item-label").html("Tipe");break;default:$("#category-menu-item-label, #category-modal-item-label").html("Kategori")}let n='<li class="nav-item font-poppins">';a.forEach(l=>{n+=`
            <a class="nav-link text-dark category-filter d-flex align-items-center justify-content-start" 
                ...
                `),$("#thumbnailGallery").append(`
                    <img src="${c}" class="img-thumbnail m-1 thumbnail-image" style="width: 5rem; height: 5rem; object-fit: cover; cursor: pointer;" data-index="${i}">
                `)}),n.length<=1?($("#carouselProduct .carousel-control-next").addClass("d-none"),$("#carouselProduct .carousel-control-prev").addClass("d-none")):($("#carouselProduct .carousel-control-next").removeClass("d-none"),$("#carouselProduct .carousel-control-prev").removeClass("d-none")),$("#thumbnailGallery").on("click",".thumbnail-image",function(){const c=$(this).data("index");$("#carouselProduct .carousel-item").removeClass("active"),$("#carouselProduct .carousel-item").eq(c).addClass("active")})}$(document).on("click",".product-card",function(){const n=$(this).data("code"),c=$(this).data("category"),i=JSON.parse($(this).attr("data-images").replace(/&quot;/g,'"')),l=$(this).data("jenis");o(i),$("#modalCode").text(n),$("#productModalLabel").text(n),$("#modalCategory").text(l+" / "+c),$("#modalDownload").data("id",$(this).data("id")),$("#productModal").modal("show"),$("#modalContact").data("jenis",l),$("#modalContact").data("category",c),$("#modalContact").data("code",n)}),O(e),B(),E(),J()});
