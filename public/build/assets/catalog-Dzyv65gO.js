...
Apakah produk ini masih tersedia? Terima kasih.`,window.open(`https://wa.me/${o}?text=${encodeURIComponent(e)}`,"_blank")})}function G(){$(window).scroll(function(){$(this).scrollTop()>100?$("#btn-scroll-top").fadeIn():$("#btn-scroll-top").fadeOut()}),$("#btn-scroll-top").click(function(){return $("html, body").animate({scrollTop:0},500),!1})}function Q(t,o){$("#btn-download").removeClass("d-none");let a="";t.forEach(e=>{var g,l,y,k,P,b,p,T,v,j,J,w;const i=e.photo?`/storage/${e.photo}`:"https://via.placeholder.com/300x200?text=No+Image",d=X(e.images),u=[i,...d],f=JSON.stringify(u).replace(/"/g,"&quot;"),c=JSON.stringify(e.packages).replace(/"/g,"&quot;"),n=((g=e.category)==null?void 0:g.name)??"Tanpa Kategori";((l=e.category)==null?void 0:l.display_style)==="square"||o===null?a+=`
                ...
                </div>`}),$("#product-list .row").append(a)}function M(t,o,a,e=!1){if(o==null)return;t.forEach(n=>{n.images&&n.images.forEach(r=>{r.path&&a.add(r.path)}),n.path&&a.add(n.path)});const i=Array.from(a),d=$("#mockup-carousel-inner"),u=$("#mockup-carousel-indicators"),f=["https://www.youtube.com/embed/BiiUrYAbL9s?autoplay=1&mute=1&rel=0&controls=0&amp;loop=1&playlist=BiiUrYAbL9s"],c=[];for(let n=1;n<=6;n++)n!==2&&c.push(`/dist/img/wpc/${n}.webp?v=${Date.now()}`);if(d.empty(),u.empty(),o==4){$("#mockup-carousel").carousel({interval:!1}),$("#mockup .carousel-control-next").addClass("d-none"),$("#mockup .carousel-control-prev").addClass("d-none"),f.forEach((n,r)=>{d.append(`
        ...
        `)}),$("#mockup").removeClass("d-none");return}else if(o==3&&e){$("#mockup-carousel").carousel({interval:3e3}),$("#mockup .carousel-control-next").removeClass("d-none"),$("#mockup .carousel-control-prev").removeClass("d-none"),c.forEach((n,r)=>{d.append(`
            <div class="carousel-item ${r===0?"active":""}">
                <div class="d-flex justify-content-center align-items-center">
                    <img src="${n}" 
                        alt="mockup" 
        ...
        `)}),$("#mockup").removeClass("d-none");return}i.length>0?(i.length===1?($("#mockup .carousel-control-next").addClass("d-none"),$("#mockup .carousel-control-prev").addClass("d-none"),u.addClass("d-none")):($("#mockup .carousel-control-next").removeClass("d-none"),$("#mockup .carousel-control-prev").removeClass("d-none"),u.removeClass("d-none")),i.forEach((n,r)=>{d.append(`
                <div class="carousel-item ${r===0?"active":""}">
