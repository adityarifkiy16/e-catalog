...
Apakah produk ini masih tersedia? Terima kasih.`,window.open(`https://wa.me/${n}?text=${encodeURIComponent(a)}`,"_blank")})}function U(){$(window).scroll(function(){$(this).scrollTop()>100?$("#btn-scroll-top").fadeIn():$("#btn-scroll-top").fadeOut()}),$("#btn-scroll-top").click(function(){return $("html, body").animate({scrollTop:0},500),!1})}function Q(){$("#loading").removeClass("d-none")}function Z(){$("#loading").addClass("d-none")}function ee(e=[]){if(!Array.isArray(e))return[];const n={thumbnail:3,motif:2,product:1};return e.slice().sort((t,a)=>(n[a.type]||0)-(n[t.type]||0)).map(t=>"/storage/"+t.path)}function ae(e,n,t){$("#btn-download").removeClass("d-none");let a="";e.forEach(o=>{var p,y,C,b,j,k,S,J,x,L,u,P,N,E,O,q,B;const i=ee(((y=(p=o==null?void 0:o.product_versions)==null?void 0:p[0])==null?void 0:y.images)??[]),g=i.length?i[0]:"https://via.placeholder.com/300x200?text=No+Image";let v=i,r=((b=(C=o.category)==null?void 0:C.types)==null?void 0:b.thumbnail)??"";r&&!r.startsWith("http")&&(r=`storage/${r.replace(/^\/?storage\//,"")}`,v.push(r));const l=JSON.stringify(v).replace(/"/g,"&quot;"),d=JSON.stringify(o.packages).replace(/"/g,"&quot;"),m=((j=o.category)==null?void 0:j.name)??"Tanpa Kategori",f=((k=o.product_versions.find(X=>X.version_id==t))==null?void 0:k.name)??"Tanpa Nama";((S=o.category)==null?void 0:S.display_style)==="square"||n===null?a+=`
                ...
                </div>`}),$("#product-list .row").append(t)}function R(e,n,t,a=!1){if(n==null)return;e.forEach(l=>{l.images&&l.images.forEach(d=>{d.path&&t.add(d.path)}),l.path&&t.add(l.path)});const o=Array.from(t),i=$("#mockup-carousel-inner"),g=$("#mockup-carousel-indicators"),v=["https://www.youtube.com/embed/BiiUrYAbL9s?autoplay=1&mute=1&rel=0&controls=0&amp;loop=1&playlist=BiiUrYAbL9s"],r=[];for(let l=1;l<=6;l++)l!==2&&r.push(`/dist/img/wpc/${l}.webp?v=${Date.now()}`);if(i.empty(),g.empty(),n==4){$("#mockup-carousel").carousel({interval:!1}),$("#mockup .carousel-control-next").addClass("d-none"),$("#mockup .carousel-control-prev").addClass("d-none"),v.forEach((l,d)=>{i.append(`
        ...
        `)}),$("#mockup").removeClass("d-none");return}else if(n==3&&a){$("#mockup-carousel").carousel({interval:3e3}),$("#mockup .carousel-control-next").removeClass("d-none"),$("#mockup .carousel-control-prev").removeClass("d-none"),r.forEach((l,d)=>{i.append(`
            <div class="carousel-item ${d===0?"active":""}">
                <div class="d-flex justify-content-center align-items-center">
                    <img src="${l}" 
                        alt="mockup" 
        ...
        `)}),$("#mockup").removeClass("d-none");return}o.length>0?(o.length===1?($("#mockup .carousel-control-next").addClass("d-none"),$("#mockup .carousel-control-prev").addClass("d-none"),g.addClass("d-none")):($("#mockup .carousel-control-next").removeClass("d-none"),$("#mockup .carousel-control-prev").removeClass("d-none"),g.removeClass("d-none")),o.forEach((l,d)=>{i.append(`
                <div class="carousel-item ${d===0?"active":""}">
            ...
            `)}),$("#mockup").removeClass("d-none")):$("#mockup").addClass("d-none")}let M=!1;function D(e){$(document).off("click",".category-filter"),$(document).on("click",".category-filter",async function(n){if(n.preventDefault(),M)return;M=!0;const t=$(this).data("id"),a=$(this).data("type"),o=$(this).data("version");try{A({selectedJenis:e,category:t,type:a,version:o}),$("#filterModal").modal("hide"),V(),await w(!1)}catch(i){console.error("Gagal memuat data:",i)}finally{M=!1}}),$(document).off("click",".type-filter"),$(document).on("click",".type-filter",async function(n){if(n.preventDefault(),M)return;M=!0;const t=$(this).data("id");try{A({selectedJenis:e,type:t}),$("#filterModal").modal("hide"),V(),await w(!1)}catch(a){console.error("Gagal memuat data:",a)}finally{M=!1}})}function T(e,n="#modalVariants"){$(n).empty(),$("#modalPaket").empty(),$("#modalKepadatan").empty(),Array.isArray(e)&&e.length>0?e.forEach(t=>{const a=t.specification_values||[],o=t.name.toLowerCase();if(o==="warna")$("#paket").text("Warna"),a.length>0?a.forEach(i=>{t.pivot&&i.id===t.pivot.specification_value_id&&$("#modalPaket").append(`
                            ...
                            `)}):$("#modalPaket").append('<span class="text-muted">Tidak ada data</span>');else if(o==="density")a.length>0?a.forEach(i=>{t.pivot&&i.id===t.pivot.specification_value_id&&(a.length>1?$("#modalKepadatan").append(`
                                ...
                                `):$("#modalKepadatan").append(i.name))}):$("#modalKepadatan").append('<span class="text-muted">Tidak ada data</span>');else{const i=a.find(l=>t.pivot&&l.id===t.pivot.specification_value_id),g=i?i.name:"-";let v=i?i.unit:"";v?v=" "+v:["panjang","tinggi","lebar"].includes(o)?v=" cm":o==="ketebalan"&&(v=" mm");const r=`
                    <div class="row mb-1 variant-row">
                        <div class="col-4 col-sm-3 font-weight-bold">${t.name}</div>
                        <div class="col-auto">:</div>
                        <div class="col">${g}${v}</div>
                    </div>
            ...
            `)}),$(".lazy-modal-img").each(function(){f.observe(this)}),m.length<=1?$("#carouselProduct .carousel-control-next, #carouselProduct .carousel-control-prev").addClass("d-none"):$("#carouselProduct .carousel-control-next, #carouselProduct .carousel-control-prev").removeClass("d-none"),$("#carouselProduct").carousel({interval:3e3,pause:!1});let c;$("#thumbnailGallery").off("click").on("click",".thumbnail-image",function(){const h=$(this).data("index");$("#carouselProduct").carousel(h),$(".thumbnail-image").removeClass("active-thumbnail"),$(this).addClass("active-thumbnail"),setTimeout(()=>$(this).removeClass("active-thumbnail"),500),$("#carouselProduct").carousel("pause"),clearTimeout(c),c=setTimeout(()=>{$("#carouselProduct").carousel("cycle")},5e3)})}$(document).off("click",".product-card").on("click",".product-card",function(){const r=$(this).data("id"),l=$(this).data("code"),d=$(this).data("name"),m=$(this).data("category"),f=$(this).data("type"),c=$(this).data("jenis"),h=parseInt($(this).data("length"),10),p=parseFloat($(this).data("width")).toFixed(1),y=parseFloat($(this).data("density")).toFixed(1),C=$(this).data("url"),b=JSON.parse($(this).attr("data-specifications")||"[]"),j=$(this).attr("data-images"),k=JSON.parse($(this).attr("data-paket")||"[]");let S=$(this).data("height"),J=$(this).data("type-image"),x=[],L=[];if(c!=="card-types"&&v(r),j)try{x=JSON.parse(j.replace(/&quot;/g,'"'))}catch(u){x=[],console.error(u)}if(Array.isArray(k)&&(L=k.sort((u,P)=>u.order-P.order).map(u=>`/storage/${u.image}`)),$("#notes").show(),$("#modalPaket").empty(),c==="card-types"){V(),A({selectedJenis:n,type:f}),I(!1),w();return}c.toLowerCase()==="uv board"&&(T(b),$("#modalVideo, .lebar").hide(),$("#modalCategory").text(m),k.length>0?k.sort((u,P)=>u.order-P.order).map(u=>{$("#modalPaket").append(`
                ...
                `),$("#modalVideo").show())),g(x,L,c),$("#modalName").text(d),$("#productModalLabel").text(d),$("#productModal").modal("show"),$("#modalContact").data({jenis:c,category:m,code:l,length:h,width:p,height:S,density:y,type:f}),$(".kepadatan").removeClass("active"),$("#modalContact").data({kepadatan:null,paket:null}),$(".modalContact").prop("disabled",$(".kepadatan").length>0)}),$(document).on("click",".kepadatan",function(){$(".modalContact").prop("disabled",!1);const r=$(this).data("value");$(this).closest("#productModal").find(".kepadatan").removeClass("active"),$(this).addClass("active"),$("#notes").hide(),$("#modalContact").data("kepadatan",r)}),D(n),z(),H(),U(),W();function v(r){$.ajax({url:`/products/${r}/viewed`,method:"POST",headers:{"X-CSRF-TOKEN":$('meta[name="csrf-token"]').attr("content")},success:l=>console.log("View recorded:",l),error:l=>console.error(l)})}});let s={selectedJenis:null,category:null,type:null,currentPage:1,isLoading:!1,lastPage:!1,firstLoad:!0,currentRequest:null,uniquePaths:new Set,version:null};function I(e){s.firstLoad=e}function A(e){s.selectedJenis=e.selectedJenis,s.category=e.category??null,s.type=e.type??null,s.version=e.version??null}function Y(){return s.isLoading}function V(){s.currentPage=1,s.isLoading=!1,s.lastPage=!1,s.uniquePaths.clear(),$("#product-list .row").html("")}function w(){if(s.isLoading||s.lastPage)return Promise.resolve();s.isLoading=!0,Q();const e=$("#search-input").val();s.currentRequest&&s.currentRequest.readyState!==4&&s.currentRequest.abort();const n={page:s.currentPage,search:e,jenis:s.selectedJenis,category:s.category,type:s.type,version:s.version};return s.currentRequest=$.ajax({url:"/catalog",type:"GET",data:n}),new Promise((t,a)=>{s.currentRequest.done(o=>oe(o)).fail((o,i)=>{i!=="abort"&&(console.error("Gagal memuat data."),a())}).always(()=>{s.isLoading=!1,Z(),s.currentRequest=null}).then(t)})}function oe(e){console.log(e);const n=e.data.data??[],t=e.types??[],a=e.active_version_id;if(s.type&&($("#backButton").removeClass("d-none"),$("#homeButton").addClass("d-none")),console.log("state.version",s.version),console.log("state.type",s.type),s.version==null){const o=$("#version-select option:first").val();o&&(s.version=o)}s.selectedJenis&&s.firstLoad&&t.length>0?($("#search-form").addClass("d-none"),$("#downloadButton").addClass("d-none"),$("#version-filter").addClass("d-none"),t.length>0&&(te(t,s.selectedJenis),s.lastPage=!0),F(e,!0)):($("#search-form").removeClass("d-none"),$("#downloadButton").removeClass("d-none"),$("#version-filter").removeClass("d-none"),n.length>0?(ae(n,s.selectedJenis,a),s.currentPage++,s.currentPage>e.data.last_page&&(s.lastPage=!0)):(s.currentPage===1&&($("#mockup").addClass("d-none"),$("#product-list .row").append(`<div class="col-12"><img src="dist/img/no-data.png" alt="no-data"
                     class="img-fluid mx-auto d-block" style="max-width:100%;height:auto;margin:100px 0;"></div>`)),s.lastPage=!0),F(e,!1))}function F(e,n=!0){var m,f,c,h,p,y,C,b;const t=e.category??[],a=((c=(f=(m=e.data.data[0])==null?void 0:m.category)==null?void 0:f.types)==null?void 0:c.images)??[],o=(h=e.jenis)==null?void 0:h.name,i=((y=(p=e.data.data[0])==null?void 0:p.category)==null?void 0:y.images)??[],g=s.firstLoad&&(((C=e.types)==null?void 0:C.length)??0)>0,v=(((b=e.category)==null?void 0:b.length)??0)>0;K({selectedJenis:s.selectedJenis,hasCategory:v,isRenderTypes:g}),t.length===0?$("#category-container").addClass("d-none"):($("#category-container").removeClass("d-none"),a.length>0?R(a,s.selectedJenis,s.uniquePaths,n):i.length>0?R(i,s.selectedJenis,s.uniquePaths,n):s.selectedJenis==3?R([],s.selectedJenis,s.uniquePaths,n):s.selectedJenis==4?R([],s.selectedJenis,s.uniquePaths,n):$("#mockup").addClass("d-none")),le(o);const r=ne(t,s.version),l=se(t),d=ie(e.types??[]);n?$("#category-menu-item, #category-menu-item-modal").html("tidak ada kategori"):($("#category-menu-item, #category-menu-item-modal").html(r),$("#type-menu-item, #type-menu-item-modal").html(d),$("#pdf-catalog").html(l)),!s.category&&t.length>0?(s.category=t[0].id,V(),setTimeout(()=>{w(),console.log("loadMoreData"),console.log("state.vers",s.version)},200)):s.category&&$(`.category-filter[data-id="${s.category}"]`).addClass("active"),s.type&&$(`.type-filter[data-id="${s.type}"]`).addClass("active")}function _(e){$("#category-menu-item-label, #category-modal-item-label").html(e)}function se(e){if(e.length===0)return`
