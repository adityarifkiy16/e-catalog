...
Apakah produk ini masih tersedia? Terima kasih.`,window.open(`https://wa.me/${s}?text=${encodeURIComponent(e)}`,"_blank")})}function G(){$(window).scroll(function(){$(this).scrollTop()>100?$("#btn-scroll-top").fadeIn():$("#btn-scroll-top").fadeOut()}),$("#btn-scroll-top").click(function(){return $("html, body").animate({scrollTop:0},500),!1})}function Q(t,s){$("#btn-download").removeClass("d-none");let a="";t.forEach(e=>{var p,l,y,k,P,b,u,T,v,j,J,C;const i=e.photo?`/storage/${e.photo}`:"https://via.placeholder.com/300x200?text=No+Image",d=X(e.images),g=[i,...d],f=JSON.stringify(g).replace(/"/g,"&quot;"),c=JSON.stringify(e.packages).replace(/"/g,"&quot;"),n=((p=e.category)==null?void 0:p.name)??"Tanpa Kategori";((l=e.category)==null?void 0:l.display_style)==="square"||s===null?a+=`
                ...
                </div>`}),$("#product-list .row").append(a)}function M(t,s,a,e=!1){if(s==null)return;t.forEach(n=>{n.images&&n.images.forEach(r=>{r.path&&a.add(r.path)}),n.path&&a.add(n.path)});const i=Array.from(a),d=$("#mockup-carousel-inner"),g=$("#mockup-carousel-indicators"),f=["https://www.youtube.com/embed/BiiUrYAbL9s?autoplay=1&mute=1&rel=0&controls=0&amp;loop=1&playlist=BiiUrYAbL9s"],c=[];for(let n=1;n<=6;n++)n!==2&&c.push(`/dist/img/wpc/${n}.webp?v=${Date.now()}`);if(d.empty(),g.empty(),s==4){$("#mockup-carousel").carousel({interval:!1}),$("#mockup .carousel-control-next").addClass("d-none"),$("#mockup .carousel-control-prev").addClass("d-none"),f.forEach((n,r)=>{d.append(`
        ...
        `)}),$("#mockup").removeClass("d-none");return}else if(s==3&&e){$("#mockup-carousel").carousel({interval:3e3}),$("#mockup .carousel-control-next").removeClass("d-none"),$("#mockup .carousel-control-prev").removeClass("d-none"),c.forEach((n,r)=>{d.append(`
            <div class="carousel-item ${r===0?"active":""}">
                <div class="d-flex justify-content-center align-items-center">
                    <img src="${n}" 
                        alt="mockup" 
        ...
        `)}),$("#mockup").removeClass("d-none");return}i.length>0?(i.length===1?($("#mockup .carousel-control-next").addClass("d-none"),$("#mockup .carousel-control-prev").addClass("d-none"),g.addClass("d-none")):($("#mockup .carousel-control-next").removeClass("d-none"),$("#mockup .carousel-control-prev").removeClass("d-none"),g.removeClass("d-none")),i.forEach((n,r)=>{d.append(`
                <div class="carousel-item ${r===0?"active":""}">
