...
Apakah produk ini masih tersedia? Terima kasih.`,window.open(`https://wa.me/${o}?text=${encodeURIComponent(e)}`,"_blank")})}function H(){$(window).scroll(function(){$(this).scrollTop()>100?$("#btn-scroll-top").fadeIn():$("#btn-scroll-top").fadeOut()}),$("#btn-scroll-top").click(function(){return $("html, body").animate({scrollTop:0},500),!1})}function W(a,o){let e="";a.forEach(t=>{var r,p,g,h,b,C,P,I,D;const i=t.photo?`/storage/${t.photo}`:"https://via.placeholder.com/300x200?text=No+Image",n=_(t.images),l=[i,...n],s=JSON.stringify(l).replace(/"/g,"&quot;"),c=((r=t.category)==null?void 0:r.name)??"Tanpa Kategori";let d=t.code;o==3?d=t.code.split(" ").slice(4).join(" ").trim():o==5?d=t.code.split(" ").slice(1).join(" "):d=t.code,((p=t.category)==null?void 0:p.display_style)==="square"||o===null?e+=`
                    ...
                    `)}),$("#mockup").removeClass("d-none")):$("#mockup").addClass("d-none")}let f=null,m=null,K=null,u=1,v=!1,k=!1;const L=new Set;function T(a){f=a.selectedJenis,m=a.category??null,K=a.type??null}function y(a=!0){return new Promise((o,e)=>{if($(window).width()<768&&$("#filter-container").addClass("d-none"),!m||m==="null"||m===""?$("#btn-download").addClass("d-none"):$("#btn-download").removeClass("d-none"),v||k)return o();v=!0,B();const t=$("#search-input").val();$.ajax({url:"/catalog",type:"GET",data:{page:u,search:t,jenis:f,category:m,type:K},success:function(i){console.log("Data berhasil dimuat."),console.log(i);const n=i.data.data??[],l=i.types??[];f==3&&a?(console.log("isFirstLoad:"+a),l.length>0&&(O(l,f),u++,u>i.data.last_page&&(k=!0)),x(i,!0)):(console.log("isFirstLoad:"+a),n.length>0?(W(n,f),u++,u>i.data.last_page&&(k=!0)):(u===1&&($("#mockup").addClass("d-none"),$("#product-list .row").append(`<div class="col-12"><img src="dist/img/no-data.png" alt="no-data"
                                class="img-fluid mx-auto d-block" style="max-width: 100%; height: auto; margin-top: 100px; margin-bottom: 100px;"></div>`)),k=!0),x(i,!1)),x(i,!1),o()},error:function(){console.log("Gagal memuat data."),e()},complete:function(){v=!1,E()}})})}function x(a,o=!0){var s,c;const e=a.category,t=(s=a.jenis)==null?void 0:s.name,n=((c=a.category[0])==null?void 0:c.images)??[];switch(e.length===0?$("#category-container").addClass("d-none"):($("#category-container").removeClass("d-none"),n.length===0&&$("#mockup").addClass("d-none"),R(n,f,L)),t){case"PVC Board":$("#category-container, #category-modal-container").addClass("d-none");break;case"Wallboard":case"UV Board":$("#category-menu-item-label, #category-modal-item-label").html("Motif");break;case"Wallpanel":break;case"Aksesoris":$("#category-container, #category-modal-container").addClass("d-none");break;default:$("#category-menu-item-label, #category-modal-item-label").html("Kategori")}let l='<li class="nav-item font-poppins">';Array.isArray(e)&&e.length>0?e.forEach(d=>{l+=`
            <a class="nav-link text-white category-filter d-flex align-items-center justify-content-start" 
                ...
                `)}),n.length<=1?($("#carouselProduct .carousel-control-next").addClass("d-none"),$("#carouselProduct .carousel-control-prev").addClass("d-none")):($("#carouselProduct .carousel-control-next").removeClass("d-none"),$("#carouselProduct .carousel-control-prev").removeClass("d-none")),$("#thumbnailGallery").on("click",".thumbnail-image",function(){const c=$(this).data("index");$("#carouselProduct .carousel-item").removeClass("active"),$("#carouselProduct .carousel-item").eq(c).addClass("active")})}$(document).on("click",".product-card",function(){const n=$(this).data("code"),l=$(this).data("category"),s=$(this).attr("data-images"),c=$(this).data("type");let d=null;s&&(d=JSON.parse(s.replace(/&quot;/g,'"')));const r=$(this).data("jenis"),p=parseInt($(this).data("length"),10),g=parseInt($(this).data("height"),10),h=parseInt($(this).data("density"),10),b=$(this).data("id");if(r==="tipe-wallpanel"){w(),T({selectedJenis:3,type:c}),y(!1),$("#filter-container").toggleClass("d-none"),$("#catalog-col").toggleClass("col-md-10 col-md-12");return}if(r.toLowerCase()==="uv board"||r.toLowerCase()==="wallboard"){console.log("Belum pilih wallpanel, tampilkan UV Board sebagai produk biasa"),i(d),$("#modalCode").text(n),$("#productModalLabel").text(n),$("#modalCategory").text(r+" / "+l),$("#modalDownload").data("id",b),$("#productModal").modal("show"),$("#panjang, #tinggi, #ketebalan, #kepadatan, #notes").hide(),$("#modalContact").data("jenis",r),$("#modalContact").data("category",l),$("#modalContact").data("code",n);return}r==="PVC Board"?($("#modalLength").text(p&&!isNaN(p)?p+" cm":"-"),$("#modalHeight").text(g&&!isNaN(g)?g+" cm":"-"),$("#modalDensity").text(h&&!isNaN(h)?h+" mm":"-"),$("#modalKepadatan").html(`
            ...
            `)):$("#panjang, #tinggi, #ketebalan, #kepadatan, #notes").hide(),r==="Wallpanel"&&$("#modalContact").data("type",c),i(d),$("#modalCode").text(n),$("#productModalLabel").text(n),$("#modalCategory").text(l+" / "+c),$("#modalDownload").data("id",b),$("#productModal").modal("show"),$("#modalContact").data("jenis",r),$("#modalContact").data("category",l),$("#modalContact").data("code",n),$("#modalContact").data("kepadatan")&&($(".kepadatan").removeClass("active"),$("#modalContact").data("kepadatan",null),$("#notes").show())}),$(document).on("click",".kepadatan",function(){let n=$(this).data("value");$(this).closest("#productModal").find(".kepadatan").removeClass("active"),$(this).addClass("active"),$("#notes").hide(),$("#modalContact").data("kepadatan",n)}),V(a),U(),G(),H()});
