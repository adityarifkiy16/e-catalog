...
Apakah produk ini masih tersedia? Terima kasih.`,window.open(`https://wa.me/${n}?text=${encodeURIComponent(e)}`,"_blank")})}function O(){$(window).scroll(function(){$(this).scrollTop()>100?$("#btn-scroll-top").fadeIn():$("#btn-scroll-top").fadeOut()}),$("#btn-scroll-top").click(function(){return $("html, body").animate({scrollTop:0},500),!1})}function U(t,n){$("#btn-download").removeClass("d-none");let o="";t.forEach(e=>{var h,m,d,u,i,y,w,T,b,x,C;const c=e.photo?`/storage/${e.photo}`:"https://via.placeholder.com/300x200?text=No+Image",p=E(e.images),f=[c,...p],g=JSON.stringify(f).replace(/"/g,"&quot;"),r=JSON.stringify(e.packages).replace(/"/g,"&quot;"),s=((h=e.category)==null?void 0:h.name)??"Tanpa Kategori";let l=e.code;n==3?l=e.code.split(" ").slice(4).join(" ").trim():n==5?l=e.code.split(" ").slice(1).join(" "):l=e.code,((m=e.category)==null?void 0:m.display_style)==="square"||n===null?o+=`
        ...
        `)}),$("#mockup").removeClass("d-none");return}else if(n==3&&e){$("#mockup-carousel").carousel({interval:3e3}),$("#mockup .carousel-control-next").removeClass("d-none"),$("#mockup .carousel-control-prev").removeClass("d-none"),r.forEach((s,l)=>{p.append(`
            <div class="carousel-item ${l===0?"active":""}">
                <div class="d-flex justify-content-center align-items-center">
                    <img src="${s}" 
                        alt="mockup" 
        ...
        `)}),$("#mockup").removeClass("d-none");return}c.length>0?(c.length===1?($("#mockup .carousel-control-next").addClass("d-none"),$("#mockup .carousel-control-prev").addClass("d-none")):($("#mockup .carousel-control-next").removeClass("d-none"),$("#mockup .carousel-control-prev").removeClass("d-none")),c.slice(0,5).forEach((s,l)=>{p.append(`
            ...
            `)}),$("#mockup").removeClass("d-none")):$("#mockup").addClass("d-none")}let a={selectedJenis:null,category:null,type:null,currentPage:1,isLoading:!1,lastPage:!1,firstLoad:!0,currentRequest:null,uniquePaths:new Set};function K(t){a.firstLoad=t}function B(t){a.selectedJenis=t.selectedJenis,a.category=t.category??null,a.type=t.type??null}function W(){return a.isLoading}function j(){a.currentPage=1,a.isLoading=!1,a.lastPage=!1,a.uniquePaths.clear(),$("#product-list .row").html("")}function v(){if(a.isLoading||a.lastPage)return Promise.resolve();console.log("loadMoreData"),a.isLoading=!0,J();const t=$("#search-input").val();return a.currentRequest&&a.currentRequest.readyState!==4&&a.currentRequest.abort(),a.currentRequest=$.ajax({url:"/catalog",type:"GET",data:{page:a.currentPage,search:t,jenis:a.selectedJenis,category:a.category,type:a.type}}),new Promise((n,o)=>{a.currentRequest.done(e=>z(e)).fail((e,c)=>{c!=="abort"&&(console.error("Gagal memuat data."),o())}).always(()=>{a.isLoading=!1,H(),a.currentRequest=null}).then(n)})}function z(t){const n=t.data.data??[],o=t.types??[];a.type&&($("#backButton").removeClass("d-none"),$("#homeButton").addClass("d-none")),a.selectedJenis==3&&a.firstLoad?(o.length>0&&($("#search-form").addClass("d-none"),_(o,a.selectedJenis),a.currentPage++,a.currentPage>t.data.last_page&&(a.lastPage=!0)),M(t,!0)):(n.length>0?(U(n,a.selectedJenis),a.currentPage++,a.currentPage>t.data.last_page&&(a.lastPage=!0)):(a.currentPage===1&&($("#mockup").addClass("d-none"),$("#product-list .row").append(`<div class="col-12"><img src="dist/img/no-data.png" alt="no-data"
                ...
                </a>`}):g+='<a class="nav-link text-white category-filter" href="#">Tanpa Kategori</a>',g+="</li>",n?$("#category-menu-item, #category-menu-item-modal").html("tidak ada kategori"):$("#category-menu-item, #category-menu-item-modal").html(g),!a.category&&o.length>0?(console.log("auto choose category"),a.category=o[0].id,q(a.category),j(),setTimeout(()=>{v()},200)):a.category&&$(`.category-filter[data-id="${a.category}"]`).addClass("active")}function P(t){$("#category-menu-item-label, #category-modal-item-label").html(t)}let S=!1;function Y(t){$(document).off("click",".category-filter"),$(document).on("click",".category-filter",async function(n){if(n.preventDefault(),S)return;S=!0;const o=$(this).data("id"),e=$(this).data("type");console.log(e);try{B({selectedJenis:t,category:o,type:e}),q(o),$("#filterModal").modal("hide"),j(),await v(!1)}catch(c){console.error("Gagal memuat data:",c)}finally{S=!1}})}function A(t=null){$(window).width()<768?$("#filter-container").addClass("d-none"):$("#filter-container").removeClass("d-none"),(t==1||t==3)&&($("#filter-container").addClass("d-none"),$("#catalog-col").removeClass("col-md-10").addClass("col-md-12"))}$(document).ready(function(){const t=new URLSearchParams(window.location.search),n=t.get("jenis"),o=t.get("category");let e,c,p=!1;(n==5||n==2)&&sessionStorage.removeItem("selectedWallpanel"),B({selectedJenis:n,category:o}),v(),n&&($("#category-container").removeClass("d-md-none"),$("#catalog-col").removeClass("center-content")),A(n),$(window).on("resize",()=>A(n)),$("#search-input").on("input",function(){clearTimeout(e),e=setTimeout(()=>{j(),v()},500)}),$(window).on("scroll",function(){clearTimeout(c),c=setTimeout(async()=>{if(p||W())return;const r=$(window).scrollTop(),s=$(window).height(),l=$(document).height();if(r+s>=l-150){p=!0;try{K(!1),await v()}finally{p=!1}}},200)});function f(r,s=[],l=""){$("#carousel-product-image").empty(),$("#thumbnailGallery").empty();let h=r||[];(l==null?void 0:l.toLowerCase())==="uv board"&&s.length&&(h=[...r,...s]),h.forEach((d,u)=>{const i=u===0?"active":"";$("#carousel-product-image").append(`
