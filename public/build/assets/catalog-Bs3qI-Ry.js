let S=null;function M(a){S=a}function L(){return S}function K(){$("#loading").removeClass("d-none")}function N(){$("#loading").addClass("d-none")}function B(a){return a.slice().sort((l,e)=>l.pivot.motif&&!e.pivot.motif?-1:!l.pivot.motif&&e.pivot.motif?1:0).map(l=>"/storage/"+l.path)}function _(){$(document).on("click",".modalDownload",function(a){a.preventDefault();const l=$(this).data("id"),e="catalog/pdf/product?id="+encodeURIComponent(l);P(this,e)}),$("#btn-download").on("click",function(a){a.preventDefault(),P(this,"catalog/pdf?category="+encodeURIComponent(L()))})}function P(a,l){const e=$(a);e.prop("disabled",!0).html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Mengunduh...'),window.open(l,"_blank"),setTimeout(()=>{e.prop("disabled",!1).html('<i class="fa fa-file-download"></i> Download')},5e3)}function A(){$(document).on("click",".modalContact",function(a){a.preventDefault(),console.log("Klik tombol order",$(this).data("code"));const l="62816659688";let e="";$(this).data("wallpanel")?e=`Halo Admin,
...
Apakah produk ini masih tersedia? Terima kasih.`,window.open(`https://wa.me/${l}?text=${encodeURIComponent(e)}`,"_blank")})}function J(){$(window).scroll(function(){$(this).scrollTop()>100?$("#btn-scroll-top").fadeIn():$("#btn-scroll-top").fadeOut()}),$("#btn-scroll-top").click(function(){return $("html, body").animate({scrollTop:0},500),!1})}function U(a,l){let e="";a.forEach(t=>{var o,m,u,p,g,x,j;const i=t.photo?`/storage/${t.photo}`:"https://via.placeholder.com/300x200?text=No+Image",c=B(t.images),n=[i,...c],s=JSON.stringify(n).replace(/"/g,"&quot;"),d=((o=t.category)==null?void 0:o.name)??"Tanpa Kategori";((m=t.category)==null?void 0:m.display_style)==="square"||l===null?e+=`
            ...
            `)):$("#panjang, #tinggi, #ketebalan, #kepadatan, #notes").hide(),$("#modalContact").data("jenis",o),$("#modalContact").data("category",s),$("#modalContact").data("code",n),console.log("Produk biasa:",n)}),$(document).on("click",".kepadatan",function(){let n=$(this).data("value");$(".kepadatan").removeClass("active"),$(this).addClass("active"),$("#notes").hide(),$("#modalContact").data("kepadatan",n)}),I(a),_(),A(),J()});
