...
Apakah produk ini masih tersedia? Terima kasih.`,window.open(`https://wa.me/${s}?text=${encodeURIComponent(e)}`,"_blank")})}function G(){$(window).scroll(function(){$(this).scrollTop()>100?$("#btn-scroll-top").fadeIn():$("#btn-scroll-top").fadeOut()}),$("#btn-scroll-top").click(function(){return $("html, body").animate({scrollTop:0},500),!1})}function D(){$("#loading").removeClass("d-none")}function Y(){$("#loading").addClass("d-none")}function z(a=[]){if(!Array.isArray(a))return[];const s={thumbnail:3,motif:2,product:1};return a.slice().sort((t,e)=>(s[e.type]||0)-(s[t.type]||0)).map(t=>"/storage/"+t.path)}function X(a,s){$("#btn-download").removeClass("d-none");let t="";a.forEach(e=>{var d,f,v,T,k,y,L,b,S,J,C,j,m,x,N,E;const i=z(((f=(d=e==null?void 0:e.product_versions)==null?void 0:d[0])==null?void 0:f.images)??[]),n=i.length?i[0]:"https://via.placeholder.com/300x200?text=No+Image";let p=i,h=((T=(v=e.category)==null?void 0:v.types)==null?void 0:T.thumbnail)??"";h&&!h.startsWith("http")&&(h=`storage/${h.replace(/^\/?storage\//,"")}`),p.push(h);const c=JSON.stringify(p).replace(/"/g,"&quot;"),l=JSON.stringify(e.packages).replace(/"/g,"&quot;"),r=((k=e.category)==null?void 0:k.name)??"Tanpa Kategori";((y=e.category)==null?void 0:y.display_style)==="square"||s===null?t+=`
        ...
        `)}),$("#mockup").removeClass("d-none");return}i.length>0?(i.length===1?($("#mockup .carousel-control-next").addClass("d-none"),$("#mockup .carousel-control-prev").addClass("d-none"),p.addClass("d-none")):($("#mockup .carousel-control-next").removeClass("d-none"),$("#mockup .carousel-control-prev").removeClass("d-none"),p.removeClass("d-none")),i.forEach((l,r)=>{n.append(`
            ...
            `)}),$("#mockup").removeClass("d-none")):$("#mockup").addClass("d-none")}let _=!1;function H(a){$(document).off("click",".category-filter"),$(document).on("click",".category-filter",async function(s){if(s.preventDefault(),_)return;_=!0;const t=$(this).data("id"),e=$(this).data("type"),i=$(this).data("version");try{R({selectedJenis:a,category:t,type:e,version:i}),$("#filterModal").modal("hide"),V(),await w(!1)}catch(n){console.error("Gagal memuat data:",n)}finally{_=!1}})}function P(a,s="#modalVariants"){$(s).empty(),$("#modalPaket").empty(),$("#modalKepadatan").empty(),Array.isArray(a)&&a.length>0?a.forEach(t=>{const e=t.specification_values||[],i=t.name.toLowerCase();if(i==="warna")$("#paket").text("Warna"),e.length>0?e.forEach(n=>{t.pivot&&n.id===t.pivot.specification_value_id&&$("#modalPaket").append(`
            ...
            `)}),u.length<=1?$("#carouselProduct .carousel-control-next, #carouselProduct .carousel-control-prev").addClass("d-none"):$("#carouselProduct .carousel-control-next, #carouselProduct .carousel-control-prev").removeClass("d-none"),$("#carouselProduct").carousel({interval:3e3,pause:!1});let g;$("#thumbnailGallery").off("click").on("click",".thumbnail-image",function(){const d=$(this).data("index");$("#carouselProduct").carousel(d),$(".thumbnail-image").removeClass("active-thumbnail"),$(this).addClass("active-thumbnail"),setTimeout(()=>$(this).removeClass("active-thumbnail"),500),$("#carouselProduct").carousel("pause"),clearTimeout(g),g=setTimeout(()=>{$("#carouselProduct").carousel("cycle")},5e3)})}$(document).off("click",".product-card").on("click",".product-card",function(){const c=$(this).data("id"),l=$(this).data("code"),r=$(this).data("name"),u=$(this).data("category"),g=$(this).data("type"),d=$(this).data("jenis"),f=parseInt($(this).data("length"),10),v=parseFloat($(this).data("width")).toFixed(1),T=parseFloat($(this).data("density")).toFixed(1),k=$(this).data("url"),y=JSON.parse($(this).attr("data-specifications")||"[]"),L=$(this).attr("data-images"),b=JSON.parse($(this).attr("data-paket")||"[]");let S=$(this).data("height"),J=$(this).data("type-image"),C=[],j=[];if(d!=="card-types"&&h(c),L)try{C=JSON.parse(L.replace(/&quot;/g,'"'))}catch(m){C=[],console.error(m)}if(Array.isArray(b)&&(j=b.sort((m,x)=>m.order-x.order).map(m=>`/storage/${m.image}`)),$("#notes").show(),$("#modalPaket").empty(),d==="card-types"){V(),R({selectedJenis:s,type:g}),M(!1),w();return}d.toLowerCase()==="uv board"&&(P(y),$("#modalVideo, .lebar").hide(),$("#modalCategory").text(u),b.length>0?b.sort((m,x)=>m.order-x.order).map(m=>{$("#modalPaket").append(`
                ...
                `),$("#modalVideo").show())),p(C,j,d),$("#modalName").text(r),$("#productModalLabel").text(r),$("#productModal").modal("show"),$("#modalContact").data({jenis:d,category:u,code:l,length:f,width:v,height:S,density:T,type:g}),$(".kepadatan").removeClass("active"),$("#modalContact").data({kepadatan:null,paket:null}),$(".modalContact").prop("disabled",$(".kepadatan").length>0)}),$(document).on("click",".kepadatan",function(){$(".modalContact").prop("disabled",!1);const c=$(this).data("value");$(this).closest("#productModal").find(".kepadatan").removeClass("active"),$(this).addClass("active"),$("#notes").hide(),$("#modalContact").data("kepadatan",c)}),H(s),B(),F(),G(),U();function h(c){$.ajax({url:`/products/${c}/viewed`,method:"POST",headers:{"X-CSRF-TOKEN":$('meta[name="csrf-token"]').attr("content")},success:l=>console.log("View recorded:",l),error:l=>console.error(l)})}});let o={selectedJenis:null,category:null,type:null,currentPage:1,isLoading:!1,lastPage:!1,firstLoad:!0,currentRequest:null,uniquePaths:new Set,version:null};function M(a){o.firstLoad=a}function R(a){o.selectedJenis=a.selectedJenis,o.category=a.category??null,o.type=a.type??null,o.version=a.version??null}function W(){return o.isLoading}function V(){o.currentPage=1,o.isLoading=!1,o.lastPage=!1,o.uniquePaths.clear(),$("#product-list .row").html("")}function w(){if(o.isLoading||o.lastPage)return Promise.resolve();o.isLoading=!0,D();const a=$("#search-input").val();o.currentRequest&&o.currentRequest.readyState!==4&&o.currentRequest.abort();const s={page:o.currentPage,search:a,jenis:o.selectedJenis,category:o.category,type:o.type,version:o.version};return o.currentRequest=$.ajax({url:"/catalog",type:"GET",data:s}),new Promise((t,e)=>{o.currentRequest.done(i=>Z(i)).fail((i,n)=>{n!=="abort"&&(console.error("Gagal memuat data."),e())}).always(()=>{o.isLoading=!1,Y(),o.currentRequest=null}).then(t)})}function Z(a){const s=a.data.data??[],t=a.types??[];if(o.type&&($("#backButton").removeClass("d-none"),$("#homeButton").addClass("d-none")),console.log("state.version",o.version),console.log("state.type",o.type),o.version==null){const e=$("#version-select option:first").val();e&&(o.version=e)}o.selectedJenis&&o.firstLoad&&t.length>0?($("#search-form").addClass("d-none"),$("#version-filter").addClass("d-none"),t.length>0&&(Q(t,o.selectedJenis),o.lastPage=!0),I(a,!0)):($("#search-form").removeClass("d-none"),$("#version-filter").removeClass("d-none"),s.length>0?(X(s,o.selectedJenis),o.currentPage++,o.currentPage>a.data.last_page&&(o.lastPage=!0)):(o.currentPage===1&&($("#mockup").addClass("d-none"),$("#product-list .row").append(`<div class="col-12"><img src="dist/img/no-data.png" alt="no-data"
                     class="img-fluid mx-auto d-block" style="max-width:100%;height:auto;margin:100px 0;"></div>`)),o.lastPage=!0),I(a,!1))}function I(a,s=!0){var r,u,g,d,f,v,T,k;const t=a.category??[],e=((g=(u=(r=a.data.data[0])==null?void 0:r.category)==null?void 0:u.types)==null?void 0:g.images)??[],i=(d=a.jenis)==null?void 0:d.name,n=((v=(f=a.data.data[0])==null?void 0:f.category)==null?void 0:v.images)??[],p=o.firstLoad&&(((T=a.types)==null?void 0:T.length)??0)>0,h=(((k=a.category)==null?void 0:k.length)??0)>0;q({selectedJenis:o.selectedJenis,hasCategory:h,isRenderTypes:p}),t.length===0?$("#category-container").addClass("d-none"):($("#category-container").removeClass("d-none"),e.length>0?K(e,o.selectedJenis,o.uniquePaths,s):n.length>0?K(n,o.selectedJenis,o.uniquePaths,s):o.selectedJenis==3?K([],o.selectedJenis,o.uniquePaths,s):o.selectedJenis==4?K([],o.selectedJenis,o.uniquePaths,s):$("#mockup").addClass("d-none")),te(i);const c=ae(t,o.version),l=ee(t);s?$("#category-menu-item, #category-menu-item-modal").html("tidak ada kategori"):($("#category-menu-item, #category-menu-item-modal").html(c),$("#pdf-catalog").html(l)),!o.category&&t.length>0?(o.category=t[0].id,V(),setTimeout(()=>{w()},200)):o.category&&$(`.category-filter[data-id="${o.category}"]`).addClass("active")}function A(a){$("#category-menu-item-label, #category-modal-item-label").html(a)}function ee(a){if(a.length===0)return`
        ...
        <div class="col-12 mb-2">
            ...
            </a>`).join("")}</li>`}function te(a){const s={"PVC Board":()=>{$("#category-container").addClass("d-none"),$(".category-modal-container").text("Tidak ada kategori")},Wallboard:()=>A("Motif"),"UV Board":()=>A("Motif"),Wallpanel:()=>A("Motif"),Aksesoris:()=>A("Ukuran"),default:()=>A("Kategori")};(s[a]||s.default)()}function O({selectedJenis:a=null,hasCategory:s=!1,isRenderTypes:t=!1}){const e=$("#filter-container"),i=$("#category-container"),n=$("#catalog-col"),p=$(window).width()<768;if(e.removeClass("d-none"),i.removeClass("d-none"),n.removeClass("col-md-12 col-md-9"),t){e.addClass("d-none"),i.addClass("d-none"),n.addClass("col-md-12");return}if(a==1){e.addClass("d-none"),i.addClass("d-none"),n.addClass("col-md-12");return}if(!s){e.addClass("d-none"),i.addClass("d-none"),n.addClass("col-md-12");return}p?(e.addClass("d-none"),i.removeClass("d-none")):(e.removeClass("d-none"),i.removeClass("d-none")),n.addClass("col-md-9")}$(document).ready(function(){const a=new URLSearchParams(window.location.search),s=a.get("jenis");a.get("version");const t=a.get("category");let e,i,n=!1;R({selectedJenis:s,category:t}),w(),O({selectedJenis:s,hasCategory:t,isRenderTypes:!1}),$(window).on("resize",()=>O({selectedJenis:s,hasCategory:t,isRenderTypes:!1})),$("#search-input").on("input",function(){clearTimeout(e),e=setTimeout(()=>{V(),w()},500)}),$(window).on("scroll",function(){clearTimeout(i),i=setTimeout(async()=>{if(n||W())return;const c=$(window).scrollTop(),l=$(window).height(),r=$(document).height();if(c+l>=r-150){n=!0;try{M(!1),await w()}finally{n=!1}}},200)});function p(c,l=[],r=""){$("#carousel-product-image").empty(),$("#thumbnailGallery").empty();let u=c||[];(r==null?void 0:r.toLowerCase())==="uv board"&&l.length&&(u=[...c,...l]),u.forEach((d,f)=>{const v=f===0?"active":"";$("#carousel-product-image").append(`
                <div class="carousel-item ${v}">
                    <img src="${d}" class="img-fluid d-block mx-auto"
                        style="width:100%;max-width:400px;aspect-ratio:1/1;object-fit:cover;border-radius:8px;border:1px solid #ccc;">
                </div>
