...
Apakah produk ini masih tersedia? Terima kasih.`,window.open(`https://wa.me/${o}?text=${encodeURIComponent(a)}`,"_blank")})}function U(){$(window).scroll(function(){$(this).scrollTop()>100?$("#btn-scroll-top").fadeIn():$("#btn-scroll-top").fadeOut()}),$("#btn-scroll-top").click(function(){return $("html, body").animate({scrollTop:0},500),!1})}function O(e,o){let t="";e.forEach(a=>{var s,c,m,p,f,v,w,C,x;const i=a.photo?`/storage/${a.photo}`:"https://via.placeholder.com/300x200?text=No+Image",n=E(a.images),l=[i,...n],d=JSON.stringify(l).replace(/"/g,"&quot;"),u=((s=a.category)==null?void 0:s.name)??"Tanpa Kategori";let r=a.code;o==3?r=a.code.split(" ").slice(4).join(" ").trim():o==5?r=a.code.split(" ").slice(1).join(" "):r=a.code,((c=a.category)==null?void 0:c.display_style)==="square"||o===null?t+=`
                    <div class="col-md-2 col-6 mb-4">
                        <div class="h-100 product-card"
                    `:((m=a.category)==null?void 0:m.display_style)==="rectangle"?t+=`
                ...
                </div>`}),$("#product-list .row").append(t)}function W(e,o,t){if(o==null)return;console.log("rendering mockup/landing page..."),console.log(e),e.forEach(l=>{l.path&&t.add(l.path)});const a=Array.from(t),i=$("#mockup-carousel-inner"),n=$("#mockup-carousel-indicators");i.empty(),n.empty(),a.length>0?(a.length===1?($("#mockup .carousel-control-next").addClass("d-none"),$("#mockup .carousel-control-prev").addClass("d-none")):($("#mockup .carousel-control-next").removeClass("d-none"),$("#mockup .carousel-control-prev").removeClass("d-none")),a.slice(0,5).forEach((l,d)=>{i.append(`
                    ...
                    `)}),$("#mockup").removeClass("d-none")):$("#mockup").addClass("d-none")}let y=null,g=null,I=null,h=1,j=!1,k=!1;const S=new Set;function L(e){y=e.selectedJenis,g=e.category??null,I=e.type??null}function b(e=!0){return new Promise((o,t)=>{if($(window).width()<768&&$("#filter-container").addClass("d-none"),!g||g==="null"||g===""?$("#btn-download").addClass("d-none"):$("#btn-download").removeClass("d-none"),j||k)return o();j=!0,M();const a=$("#search-input").val();$.ajax({url:"/catalog",type:"GET",data:{page:h,search:a,jenis:y,category:g,type:I},success:function(i){console.log("Data berhasil dimuat."),console.log(i);const n=i.data.data??[],l=i.types??[];I&&($("#backButton").removeClass("d-none"),$("#homeButton").addClass("d-none"),console.log("remove class")),y==3&&e?(console.log("isFirstLoad:"+e),l.length>0&&(R(l,y),h++,h>i.data.last_page&&(k=!0)),T(i,!0)):(console.log("isFirstLoad:"+e),n.length>0?(O(n,y),h++,h>i.data.last_page&&(k=!0)):(h===1&&($("#mockup").addClass("d-none"),$("#product-list .row").append(`<div class="col-12"><img src="dist/img/no-data.png" alt="no-data"
                                class="img-fluid mx-auto d-block" style="max-width: 100%; height: auto; margin-top: 100px; margin-bottom: 100px;"></div>`)),k=!0),T(i,!1)),T(i,!1),o()},error:function(){console.log("Gagal memuat data."),t()},complete:function(){j=!1,H()}})})}function T(e,o=!0){var d,u,r;const t=e.category,a=(d=e.jenis)==null?void 0:d.name,n=((r=(u=e.data.data[0])==null?void 0:u.category)==null?void 0:r.images)??[];switch(t.length===0?$("#category-container").addClass("d-none"):($("#category-container").removeClass("d-none"),n.length===0&&$("#mockup").addClass("d-none"),W(n,y,S)),a){case"PVC Board":$("#category-container, #category-modal-container").addClass("d-none");break;case"Wallboard":case"UV Board":$("#category-menu-item-label, #category-modal-item-label").html("Motif");break;case"Wallpanel":break;case"Aksesoris":$("#category-container, #category-modal-container").addClass("d-none");break;default:$("#category-menu-item-label, #category-modal-item-label").html("Kategori")}let l='<li class="nav-item font-poppins">';Array.isArray(t)&&t.length>0?t.forEach(s=>{l+=`
            <a class="nav-link text-white category-filter d-flex align-items-center justify-content-start" 
            ...
            </a>`}):l+='<a class="nav-link text-white category-filter" href="#">Tanpa Kategori</a>',l+="</li>",$("#category-menu-item, #category-menu-item-modal").html(l),!g&&t.length>0?(g=t[0].id,K(g),P(),b(o)):g&&$(`.category-filter[data-id="${g}"]`).addClass("active")}function P(){h=1,j=!1,k=!1,S.clear(),$("#product-list .row").html("")}let N=!1;function J(e){$(document).off("click",".category-filter"),$(document).on("click",".category-filter",async function(o){if(o.preventDefault(),N)return;N=!0;const t=$(this).data("id"),a=$(this).data("type");console.log(a);try{L({selectedJenis:e,category:t,type:a}),K(t),$("#filterModal").modal("hide"),P(),await b(!1)}catch(i){console.error("Gagal memuat data:",i)}finally{N=!1}})}$(document).ready(function(){let e=new URLSearchParams(window.location.search).get("jenis"),o=new URLSearchParams(window.location.search).get("category"),t,a;(e==5||e==2)&&sessionStorage.removeItem("selectedWallpanel"),L({selectedJenis:e,category:o}),b(),e&&($("#category-container").removeClass("d-md-none"),$("#catalog-col").removeClass("center-content")),$(window).width()<768&&$("#filter-container").addClass("d-none"),(e==1||e==3||e==4)&&($("#filter-container").addClass("d-none"),$("#catalog-col").removeClass("col-md-10"),$("#catalog-col").addClass("col-md-12")),$("#search-input").on("input",function(){clearTimeout(t),t=setTimeout(()=>{P(),b()},500)}),$(window).on("scroll",function(){clearTimeout(a),a=setTimeout(()=>{const n=$(window).scrollTop(),l=$(window).height(),d=$(document).height();n+l>=d-150&&b(!1)},200)});function i(n,l=null,d=null){$("#carousel-product-image").empty(),$("#thumbnailGallery").empty();let u=[...n];d.toLowerCase()=="uv board"?u=[...n,...l]:u=[...n],u.forEach((s,c)=>{const m=c===0?"active":"";$("#carousel-product-image").append(`
                ...
                `),$("#thumbnailGallery").append(`
                    ...
                    `)}),n.length<=1?($("#carouselProduct .carousel-control-next").addClass("d-none"),$("#carouselProduct .carousel-control-prev").addClass("d-none")):($("#carouselProduct .carousel-control-next").removeClass("d-none"),$("#carouselProduct .carousel-control-prev").removeClass("d-none")),$("#carouselProduct").carousel({interval:3e3,pause:!1});let r;$("#thumbnailGallery").off("click").on("click",".thumbnail-image",function(){const s=$(this).data("index");$("#carouselProduct").carousel(s),$(".thumbnail-image").removeClass("active-thumbnail"),$(this).addClass("active-thumbnail"),setTimeout(()=>{$(this).removeClass("active-thumbnail")},500),$("#carouselProduct").carousel("pause"),clearTimeout(r),r=setTimeout(()=>{$("#carouselProduct").carousel("cycle")},5e3)})}$(document).on("click",".product-card",function(){const n=$(this).data("code"),l=$(this).data("category"),d=$(this).attr("data-images"),u=$(this).data("type");let r=null,s=[{path:`/dist/img/paket/1.png?v=${Date.now()}`},{path:`/dist/img/paket/2.png?v=${Date.now()}`},{path:`/dist/img/paket/3.png?v=${Date.now()}`}];s=s.map(x=>x.path),d&&(r=JSON.parse(d.replace(/&quot;/g,'"')));const c=$(this).data("jenis"),m=parseInt($(this).data("length"),10),p=parseInt($(this).data("height"),10),f=parseInt($(this).data("density"),10),v=$(this).data("id");if(c==="tipe-wallpanel"){P(),L({selectedJenis:3,type:u}),b(!1),$("#filter-container").toggleClass("d-none"),$("#catalog-col").toggleClass("col-md-10 col-md-12");return}c.toLowerCase()==="uv board"&&($("#ketebalan, #kepadatan").hide(),$("#modalCategory").text(l),$("#modalLength").text(m&&!isNaN(m)?m+" cm":"-"),$("#modalHeight").text(p&&!isNaN(p)?p+" cm":"-"),$("#modalPaket").html(`
            ...
            `)),c.toLowerCase()==="wallboard"&&($("#modalCategory").text(l),$("#modalLength").text(m&&!isNaN(m)?m+" cm":"-"),$("#modalHeight").text(p&&!isNaN(p)?p+" cm":"-"),$("#ketebalan, #kepadatan, #notes, .paket").hide()),c==="PVC Board"&&($("#modalCategory").text(c),$("#modalLength").text(m&&!isNaN(m)?m+" cm":"-"),$("#modalHeight").text(p&&!isNaN(p)?p+" cm":"-"),$("#modalDensity").text(f&&!isNaN(f)?f+" mm":"-"),$("#modalKepadatan").html(`
            ...
            `),$(".paket").hide()),c==="Wallpanel"&&($("#modalContact").data("type",u),$("#modalCategory").text(l+" / "+u),$("#panjang, #tinggi, #ketebalan, #kepadatan, #notes, .paket").hide()),c.toLowerCase()==="aksesoris"&&($("#panjang, #tinggi, #ketebalan, #kepadatan, #notes, .paket").hide(),$("#modalCategory").text(l)),i(r,s,c),$("#modalCode").text(n),$("#productModalLabel").text(n),$("#modalDownload").data("id",v),$("#productModal").modal("show"),$("#modalContact").data("jenis",c),$("#modalContact").data("category",l),$("#modalContact").data("code",n);let w=$("#modalContact").data("kepadatan"),C=$("#modalContact").data("paket");w&&($(".kepadatan").removeClass("active"),$("#modalContact").data("kepadatan",null),$("#notes").show()),C&&($(".kepadatan").removeClass("active"),$("#modalContact").data("kepadatan",null),$("#notes").show())}),$(document).on("click",".kepadatan",function(){let n=$(this).data("value");$(this).closest("#productModal").find(".kepadatan").removeClass("active"),$(this).addClass("active"),$("#notes").hide(),$("#modalContact").data("kepadatan",n)}),J(e),_(),G(),U()});
