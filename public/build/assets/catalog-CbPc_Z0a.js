...
Apakah produk ini masih tersedia? Terima kasih.`,window.open(`https://wa.me/${s}?text=${encodeURIComponent(e)}`,"_blank")})}function G(){$(window).scroll(function(){$(this).scrollTop()>100?$("#btn-scroll-top").fadeIn():$("#btn-scroll-top").fadeOut()}),$("#btn-scroll-top").click(function(){return $("html, body").animate({scrollTop:0},500),!1})}function Q(t,s){$("#btn-download").removeClass("d-none");let a="";t.forEach(e=>{var g,c,y,k,P,b,p,T,v,j,J,C;const l=e.photo?`/storage/${e.photo}`:"https://via.placeholder.com/300x200?text=No+Image",i=X(e.images),h=[l,...i],u=JSON.stringify(h).replace(/"/g,"&quot;"),d=JSON.stringify(e.packages).replace(/"/g,"&quot;"),n=((g=e.category)==null?void 0:g.name)??"Tanpa Kategori";((c=e.category)==null?void 0:c.display_style)==="square"||s===null?a+=`
                ...
                </div>`}),$("#product-list .row").append(a)}function M(t,s,a,e=!1){if(s==null)return;t.forEach(n=>{n.images&&n.images.forEach(r=>{r.path&&a.add(r.path)}),n.path&&a.add(n.path)});const l=Array.from(a),i=$("#mockup-carousel-inner"),h=$("#mockup-carousel-indicators"),u=["https://www.youtube.com/embed/BiiUrYAbL9s?autoplay=1&mute=1&rel=0&controls=0&amp;loop=1&playlist=BiiUrYAbL9s"],d=[];for(let n=1;n<=6;n++)n!==2&&d.push(`/dist/img/wpc/${n}.webp?v=${Date.now()}`);if(i.empty(),h.empty(),s==4){$("#mockup-carousel").carousel({interval:!1}),$("#mockup .carousel-control-next").addClass("d-none"),$("#mockup .carousel-control-prev").addClass("d-none"),u.forEach((n,r)=>{i.append(`
        ...
        `)}),$("#mockup").removeClass("d-none");return}l.length>0?(l.length===1?($("#mockup .carousel-control-next").addClass("d-none"),$("#mockup .carousel-control-prev").addClass("d-none"),h.addClass("d-none")):($("#mockup .carousel-control-next").removeClass("d-none"),$("#mockup .carousel-control-prev").removeClass("d-none"),h.removeClass("d-none")),l.slice(0,5).forEach((n,r)=>{i.append(`
            ...
            `)}),$("#mockup").removeClass("d-none")):$("#mockup").addClass("d-none")}let K=!1;function H(t){$(document).off("click",".category-filter"),$(document).on("click",".category-filter",async function(s){if(s.preventDefault(),K)return;K=!0;const a=$(this).data("id"),e=$(this).data("type");try{A({selectedJenis:t,category:a,type:e}),F(a),$("#filterModal").modal("hide"),V(),await x(!1)}catch(l){console.error("Gagal memuat data:",l)}finally{K=!1}})}function w(t,s="#modalVariants"){$(s).empty(),$("#modalPaket").empty(),$("#modalKepadatan").empty(),Array.isArray(t)&&t.length>0?t.forEach(a=>{const e=a.specification_values||[],l=a.name.toLowerCase();if(l==="warna")$("#paket").text("Warna"),e.length>0?e.forEach(i=>{a.pivot&&i.id===a.pivot.specification_value_id&&$("#modalPaket").append(`
                            ...
                            `)}):$("#modalPaket").append('<span class="text-muted">Tidak ada data</span>');else if(l==="density")e.length>0?e.forEach(i=>{a.pivot&&i.id===a.pivot.specification_value_id&&(e.length>1?$("#modalKepadatan").append(`
                                ...
                                `):$("#modalKepadatan").append(i.name))}):$("#modalKepadatan").append('<span class="text-muted">Tidak ada data</span>');else{const i=e.find(n=>a.pivot&&n.id===a.pivot.specification_value_id),h=i?i.name:"-";let u=i?i.unit:"";u?u=" "+u:["panjang","tinggi","lebar"].includes(l)?u=" cm":l==="ketebalan"&&(u=" mm");const d=`
                    <div class="row mb-1 variant-row">
                        <div class="col-4 col-sm-3 font-weight-bold">${a.name}</div>
                        <div class="col-auto">:</div>
                        <div class="col">${h}${u}</div>
                    </div>
                `;$(s).append(d)}}):($(s).append('<div class="text-muted">Tidak ada varian</div>'),$(".paket").hide())}function q({selectedJenis:t=null,hasCategory:s=!1,isRenderTypes:a=!1}){const e=$("#filter-container"),l=$("#category-container"),i=$("#catalog-col"),h=$(window).width()<768;if(e.removeClass("d-none"),l.removeClass("d-none"),i.removeClass("col-md-12 col-md-9"),a){e.addClass("d-none"),l.addClass("d-none"),i.addClass("col-md-12");return}if(t==1){e.addClass("d-none"),l.addClass("d-none"),i.addClass("col-md-12");return}if(!s){e.addClass("d-none"),l.addClass("d-none"),i.addClass("col-md-12");return}h?(e.addClass("d-none"),l.removeClass("d-none")):(e.removeClass("d-none"),l.removeClass("d-none")),i.addClass("col-md-9")}$(document).ready(function(){const t=new URLSearchParams(window.location.search),s=t.get("jenis"),a=t.get("category");let e,l,i=!1;A({selectedJenis:s,category:a}),x(),q({selectedJenis:s,hasCategory:a,isRenderTypes:!1}),$(window).on("resize",()=>q({selectedJenis:s,hasCategory:a,isRenderTypes:!1})),$("#search-input").on("input",function(){clearTimeout(e),e=setTimeout(()=>{V(),x()},500)}),$(window).on("scroll",function(){clearTimeout(l),l=setTimeout(async()=>{if(i||U())return;const d=$(window).scrollTop(),n=$(window).height(),r=$(document).height();if(d+n>=r-150){i=!0;try{I(!1),await x()}finally{i=!1}}},200)});function h(d,n=[],r=""){$("#carousel-product-image").empty(),$("#thumbnailGallery").empty();let m=d||[];(r==null?void 0:r.toLowerCase())==="uv board"&&n.length&&(m=[...d,...n]),m.forEach((c,y)=>{const k=y===0?"active":"";$("#carousel-product-image").append(`
            ...
            `)}),m.length<=1?$("#carouselProduct .carousel-control-next, #carouselProduct .carousel-control-prev").addClass("d-none"):$("#carouselProduct .carousel-control-next, #carouselProduct .carousel-control-prev").removeClass("d-none"),$("#carouselProduct").carousel({interval:3e3,pause:!1});let g;$("#thumbnailGallery").off("click").on("click",".thumbnail-image",function(){const c=$(this).data("index");$("#carouselProduct").carousel(c),$(".thumbnail-image").removeClass("active-thumbnail"),$(this).addClass("active-thumbnail"),setTimeout(()=>$(this).removeClass("active-thumbnail"),500),$("#carouselProduct").carousel("pause"),clearTimeout(g),g=setTimeout(()=>{$("#carouselProduct").carousel("cycle")},5e3)})}$(document).on("click",".product-card",function(){const d=$(this).data("id"),n=$(this).data("code"),r=$(this).data("name"),m=$(this).data("category"),g=$(this).data("type"),c=$(this).data("jenis"),y=parseInt($(this).data("length"),10),k=parseFloat($(this).data("width")).toFixed(1),P=parseFloat($(this).data("density")).toFixed(1),b=$(this).data("url"),p=JSON.parse($(this).attr("data-specifications")||"[]"),T=$(this).attr("data-images"),v=JSON.parse($(this).attr("data-paket")||"[]");let j=$(this).data("height"),J=$(this).data("type-image"),C=[],S=[];if(T)try{C=JSON.parse(T.replace(/&quot;/g,'"'))}catch{C=[]}if(Array.isArray(v)&&(S=v.sort((f,L)=>f.order-L.order).map(f=>`/storage/${f.image}`)),$("#notes").show(),$("#modalPaket").empty(),c==="card-types"){V(),A({selectedJenis:s,type:g}),I(!1),x(),handleFilterContainer(m);return}c.toLowerCase()==="uv board"&&(u(d),w(p),$("#modalVideo, .lebar").hide(),$("#modalCategory").text(m),v.length>0?v.sort((f,L)=>f.order-L.order).map(f=>{$("#modalPaket").append(`
                ...
                </a>`}):n+='<a class="nav-link text-white category-filter" href="#">Tanpa Kategori</a>',n+="</li>",s?$("#category-menu-item, #category-menu-item-modal").html("tidak ada kategori"):$("#category-menu-item, #category-menu-item-modal").html(n),!o.category&&a.length>0?(o.category=a[0].id,F(o.category),V(),setTimeout(()=>{x()},200)):o.category&&$(`.category-filter[data-id="${o.category}"]`).addClass("active")}function R(t){$("#category-menu-item-label, #category-modal-item-label").html(t)}function O({selectedJenis:t=null,hasCategory:s=!1,isRenderTypes:a=!1}){const e=$("#filter-container"),l=$("#category-container"),i=$("#catalog-col"),h=$(window).width()<768;if(e.removeClass("d-none"),l.removeClass("d-none"),i.removeClass("col-md-12 col-md-9"),a){e.addClass("d-none"),l.addClass("d-none"),i.addClass("col-md-12");return}if(t==1){e.addClass("d-none"),l.addClass("d-none"),i.addClass("col-md-12");return}if(!s){e.addClass("d-none"),l.addClass("d-none"),i.addClass("col-md-12");return}h?(e.addClass("d-none"),l.removeClass("d-none")):(e.removeClass("d-none"),l.removeClass("d-none")),i.addClass("col-md-9")}$(document).ready(function(){const t=new URLSearchParams(window.location.search),s=t.get("jenis"),a=t.get("category");let e,l,i=!1;A({selectedJenis:s,category:a}),x(),O({selectedJenis:s,hasCategory:a,isRenderTypes:!1}),$(window).on("resize",()=>O({selectedJenis:s,hasCategory:a,isRenderTypes:!1})),$("#search-input").on("input",function(){clearTimeout(e),e=setTimeout(()=>{V(),x()},500)}),$(window).on("scroll",function(){clearTimeout(l),l=setTimeout(async()=>{if(i||U())return;const d=$(window).scrollTop(),n=$(window).height(),r=$(document).height();if(d+n>=r-150){i=!0;try{I(!1),await x()}finally{i=!1}}},200)});function h(d,n=[],r=""){$("#carousel-product-image").empty(),$("#thumbnailGallery").empty();let m=d||[];(r==null?void 0:r.toLowerCase())==="uv board"&&n.length&&(m=[...d,...n]),m.forEach((c,y)=>{const k=y===0?"active":"";$("#carousel-product-image").append(`
                <div class="carousel-item ${k}">
                    <img src="${c}" class="img-fluid d-block mx-auto"
                        style="width:100%;max-width:400px;aspect-ratio:1/1;object-fit:cover;border-radius:8px;border:1px solid #ccc;">
                </div>
