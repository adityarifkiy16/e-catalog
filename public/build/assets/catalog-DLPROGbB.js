...
Apakah produk ini masih tersedia? Terima kasih.`;window.open(`https://wa.me/${a}?text=${encodeURIComponent(t)}`,"_blank")})}function J(){$(window).scroll(function(){$(this).scrollTop()>100?$("#btn-scroll-top").fadeIn():$("#btn-scroll-top").fadeOut()}),$("#btn-scroll-top").click(function(){return $("html, body").animate({scrollTop:0},500),!1})}function L(e,a){let t="";e.forEach(o=>{var h,y,b,v,w,C,x;const n=o.photo?`/storage/${o.photo}`:"https://via.placeholder.com/300x200?text=No+Image",c=_(o.images),s=[n,...c],l=JSON.stringify(s).replace(/"/g,"&quot;"),f=((h=o.category)==null?void 0:h.name)??"Tanpa Kategori";((y=o.category)==null?void 0:y.display_style)==="square"||a===null?t+=`
                    ...
                    `)}),$("#mockup").removeClass("d-none")):$("#mockup").addClass("d-none")}let g=null,i=null,r=1,d=!1,u=!1;const T=new Set;function I(e){g=e.selectedJenis,i=e.category??null}function m(){if(!i||i==="null"||i===""?$("#btn-download").addClass("d-none"):$("#btn-download").removeClass("d-none"),d||u)return;d=!0,M();const e=$("#search-input").val();$.ajax({url:"/catalog",type:"GET",data:{page:r,search:e,jenis:g,category:i},success:function(a){const t=a.data.data??[];t.length>0?(L(t,g),r++,r>a.data.last_page&&(u=!0)):(r===1&&($("#mockup").addClass("d-none"),$("#product-list .row").append(`<div class="col-12"><img src="dist/img/no-data.png" alt="no-data"
                            class="img-fluid mx-auto d-block" style="max-width: 100%; height: auto; margin-top: 100px; margin-bottom: 100px;"></div>`)),u=!0),G(a),d=!1},error:function(){d=!1,console.log("Gagal memuat data.")},complete:function(){d=!1,S()}})}function G(e){var c,s;const a=((c=e.jenis)==null?void 0:c.categories)??[],t=(s=e.jenis)==null?void 0:s.name,o=e;switch(a.length===0?$("#category-container").addClass("d-none"):$("#category-container").removeClass("d-none"),U(o.category.images,g,T),t){case"PVC Board":$("#category-container, #category-modal-container").addClass("d-none");break;case"Wallboard":case"UV Board":$("#category-menu-item-label, #category-modal-item-label").html("Motif");break;case"Wallpanel":$("#category-menu-item-label, #category-modal-item-label").addClass("d-none");break;default:$("#category-menu-item-label, #category-modal-item-label").html("Kategori")}let n='<li class="nav-item font-poppins">';a.forEach(l=>{n+=`
