...
Apakah produk ini masih tersedia? Terima kasih.`,window.open(`https://wa.me/${n}?text=${encodeURIComponent(a)}`,"_blank")})}function Y(){$(window).scroll(function(){$(this).scrollTop()>100?$("#btn-scroll-top").fadeIn():$("#btn-scroll-top").fadeOut()}),$("#btn-scroll-top").click(function(){return $("html, body").animate({scrollTop:0},500),!1})}function W(e){s.firstLoad=e}function X(){return s.isLoading}function C(e){s.selectedJenis=e.selectedJenis,s.category=e.category??null,s.type=e.type??null,s.version=e.version??null}function y(){s.currentPage=1,s.isLoading=!1,s.lastPage=!1,s.uniquePaths.clear(),$("#product-list .row").html("")}function Q(e){return s.currentRequest&&s.currentRequest.readyState!==4&&s.currentRequest.abort(),s.currentRequest=$.ajax({url:"/catalog",type:"GET",data:e})}function Z(e){$.ajax({url:`/products/${e}/viewed`,method:"POST",headers:{"X-CSRF-TOKEN":$('meta[name="csrf-token"]').attr("content")},success:n=>console.log("View recorded:",n),error:n=>console.error(n)})}function ee(){$("#loading").removeClass("d-none")}function ae(){$("#loading").addClass("d-none")}function te(e=[]){if(!Array.isArray(e))return[];const n={thumbnail:3,motif:2,product:1};return e.slice().sort((t,a)=>(n[a.type]||0)-(n[t.type]||0)).map(t=>"/storage/"+t.path)}function oe(e,n){$("#btn-download").addClass("d-none");let t="";e.forEach(a=>{const o=a.thumbnail?`/storage/${a.thumbnail}`:"https://via.placeholder.com/300x200?text=No+Image",i=n==3?"wallpanel":"tanpa kategori";t+=`
                ...
                </div>`}),$("#product-list .row").append(t)}function ne(e){const n={"PVC Board":()=>{$("#category-container").addClass("d-none"),$(".category-modal-container").text("Tidak ada kategori")},Wallboard:()=>b("Motif"),"UV Board":()=>b("Motif"),Wallpanel:()=>b("Motif"),Aksesoris:()=>b("Ukuran"),default:()=>b("Kategori")};(n[e]||n.default)()}function b(e){$("#category-menu-item-label, #category-modal-item-label").html(e)}function P({selectedJenis:e=null,hasCategory:n=!1,isRenderTypes:t=!1}){const a=$("#filter-container"),o=$("#category-container"),i=$("#catalog-col"),l=$(window).width()<768;if(a.removeClass("d-none"),o.removeClass("d-none"),i.removeClass("col-md-12 col-md-9"),t){a.addClass("d-none"),o.addClass("d-none"),i.addClass("col-md-12");return}if(e==1){a.addClass("d-none"),o.addClass("d-none"),i.addClass("col-md-12");return}if(!n){a.addClass("d-none"),o.addClass("d-none"),i.addClass("col-md-12");return}l?(a.addClass("d-none"),o.removeClass("d-none")):(a.removeClass("d-none"),o.removeClass("d-none")),i.addClass("col-md-9")}function se(e,n=null){return e.length===0?`
        ...
        <div class="col-12 mb-2">
            ...
            </div>`).join("");return`<div class="row font-poppins">${n}${t}</div>`}function le(e){return e.length===0&&$("#type-menu-item-label").hide(),`<li class="nav-item font-poppins">${e.map(t=>`
        ...
        `)}),$("#mockup").removeClass("d-none");return}o.length>0?(o.length===1?($("#mockup .carousel-control-next").addClass("d-none"),$("#mockup .carousel-control-prev").addClass("d-none"),l.addClass("d-none")):($("#mockup .carousel-control-next").removeClass("d-none"),$("#mockup .carousel-control-prev").removeClass("d-none"),l.removeClass("d-none")),o.forEach((d,c)=>{let p=c===0?"eager":"lazy",f=c===0?"high":"low";i.append(`
            ...
            `)}),$("#mockup").removeClass("d-none")):$("#mockup").addClass("d-none")}function U(e,n=!0){var i,l,r;const t=e.data.data[0],a=((l=(i=t==null?void 0:t.category)==null?void 0:i.type)==null?void 0:l.images)??[],o=((r=t==null?void 0:t.category)==null?void 0:r.images)??[];a.length>0?w(a,s.selectedJenis,s.uniquePaths,n):o.length>0?w(o,s.selectedJenis,s.uniquePaths,n):s.selectedJenis==3?w([],s.selectedJenis,s.uniquePaths,n):s.selectedJenis==4?w([],s.selectedJenis,s.uniquePaths,n):$("#mockup").addClass("d-none")}function re(e,n,t){$("#btn-download").removeClass("d-none");let a="";e.forEach(o=>{var T,j,L,J,S,_,A,M,V,K,R,E,q,B,I,N,O;const i=te(((j=(T=o==null?void 0:o.product_versions)==null?void 0:T[0])==null?void 0:j.images)??[]),l=i.length?i[0]:"https://via.placeholder.com/300x200?text=No+Image";let r=i,u=((J=(L=o.category)==null?void 0:L.type)==null?void 0:J.thumbnail)??"";u&&!u.startsWith("http")&&(u=`storage/${u.replace(/^\/?storage\//,"")}`,r.push(u));const d=JSON.stringify(r).replace(/"/g,"&quot;"),c=JSON.stringify(o.packages).replace(/"/g,"&quot;"),p=((S=o.category)==null?void 0:S.name)??"Tanpa Kategori",f=((_=o.product_versions.find(z=>z.version_id==t))==null?void 0:_.name)??"Tanpa Nama";((A=o.category)==null?void 0:A.display_style)==="square"||n===null?a+=`
                    <div class="col-md-2 col-6 mb-4">
                ...
                </div>`}),$("#product-list .row").append(a)}function g(){if(s.isLoading||s.lastPage)return Promise.resolve();s.isLoading=!0,ee();const e=$("#search-input").val(),n={page:s.currentPage,search:e,jenis:s.selectedJenis,category:s.category,type:s.type,version:s.version};return Q(n).done(de).always(()=>{s.isLoading=!1,ae(),s.currentRequest=null})}function de(e){const n=e.data.data??[],t=e.types??[],a=e.active_version_id;if(s.type&&($("#backButton").removeClass("d-none"),$("#homeButton").addClass("d-none")),s.version==null){const o=$("#version-select option:first").val();o&&(s.version=o)}if(!s.category&&Array.isArray(e.category)&&e.category.length>0){const o=e.category[0].id;s.category=o,y(),setTimeout(()=>g(),0);return}s.selectedJenis&&s.firstLoad&&t.length>0?($("#search-form").addClass("d-none"),$("#downloadButton").addClass("d-none"),$("#version-filter").addClass("d-none"),t.length>0&&(oe(t,s.selectedJenis),s.lastPage=!0),H(e,!0),U(e,!0)):($("#search-form").removeClass("d-none"),$("#downloadButton").removeClass("d-none"),$("#version-filter").removeClass("d-none"),n.length>0?(re(n,s.selectedJenis,a),s.currentPage++,s.currentPage>e.data.last_page&&(s.lastPage=!0)):(s.currentPage===1&&($("#mockup").addClass("d-none"),$("#product-list .row").append(`<div class="col-12"><img src="dist/img/no-data.png" alt="no-data"
                     class="img-fluid mx-auto d-block" style="max-width:100%;height:auto;margin:100px 0;"></div>`)),s.lastPage=!0),H(e,!1),U(e,!1))}function ce(e={}){const n=new URL(window.location.href),t=n.searchParams;Object.entries(e).forEach(([a,o])=>{o==null||o===""?t.delete(a):t.set(a,o)}),window.history.replaceState({},"",n.toString())}let h=!1;function ue(e){$(document).off("click",".category-filter"),$(document).on("click",".category-filter",async function(n){if(n.preventDefault(),h)return;h=!0;const t=$(this).data("id"),a=$(this).data("type"),o=$(this).data("version");try{ce({category:t,type:a,version:o,jenis:e}),C({selectedJenis:e,category:t,type:a,version:o}),$("#filterModal").modal("hide"),y(),await g(!1)}catch(i){console.error("Gagal memuat data:",i)}finally{h=!1}}),$(document).off("click",".type-filter"),$(document).on("click",".type-filter",async function(n){if(n.preventDefault(),h)return;h=!0;const t=$(this).data("id");try{C({selectedJenis:e,type:t}),$("#filterModal").modal("hide"),y(),await g(!1)}catch(a){console.error("Gagal memuat data:",a)}finally{h=!1}})}function me(){$("#version-select").on("change",function(){const e=$(this).val()||null;s.version=e,y(),g()})}function k(e,n="#modalVariants"){$(n).empty(),$("#modalPaket").empty(),$("#modalKepadatan").empty(),Array.isArray(e)&&e.length>0?e.forEach(t=>{const a=t.specification_values||[],o=t.name.toLowerCase();if(o==="warna")$("#paket").text("Warna"),a.length>0?a.forEach(i=>{t.pivot&&i.id===t.pivot.specification_value_id&&$("#modalPaket").append(`
