...
Apakah produk ini masih tersedia? Terima kasih.`,window.open(`https://wa.me/${o}?text=${encodeURIComponent(a)}`,"_blank")})}function Y(){$(window).scroll(function(){$(this).scrollTop()>100?$("#btn-scroll-top").fadeIn():$("#btn-scroll-top").fadeOut()}),$("#btn-scroll-top").click(function(){return $("html, body").animate({scrollTop:0},500),!1})}function z(e,o){$("#btn-download").removeClass("d-none");let t="";e.forEach(a=>{var p,f,b,g,m,u,w,h,P;const c=a.photo?`/storage/${a.photo}`:"https://via.placeholder.com/300x200?text=No+Image",s=W(a.images),l=[c,...s],r=JSON.stringify(l).replace(/"/g,"&quot;"),n=JSON.stringify(a.packages).replace(/"/g,"&quot;"),i=((p=a.category)==null?void 0:p.name)??"Tanpa Kategori";let d=a.code;o==3?d=a.code.split(" ").slice(4).join(" ").trim():o==5?d=a.code.split(" ").slice(1).join(" "):d=a.code,((f=a.category)==null?void 0:f.display_style)==="square"||o===null?t+=`
                    ...
                    data-code="${d}"
                    data-category="${i}"
                    data-jenis="${((m=(g=a.category)==null?void 0:g.jenis)==null?void 0:m.name)??""}"
                    ...
                    data-images="${r}"
                    data-image="${c}"
                    data-type="${((w=(u=a.category)==null?void 0:u.types)==null?void 0:w.name)??""}"
                    ...
                    >
                       <img 
                            ...
                            style="
                                ...
                                width: 100%; 
                                object-fit: cover; 
                                object-position: ${((P=(h=a.category)==null?void 0:h.jenis)==null?void 0:P.name)==="PVC Board"?"bottom center":"center center"};
                            "
                        >
                ...
                </div>`}),$("#product-list .row").append(t)}function X(e,o){$("#btn-download").addClass("d-none");let t="";e.forEach(a=>{const c=a.thumbnail?`/storage/${a.thumbnail}`:"https://via.placeholder.com/300x200?text=No+Image";console.log(o);const s=o==3?"wallpanel":"tanpa kategori";t+=`
                    <div class="col-md-2 col-6 mb-4">
                        <div class="h-100 product-card d-flex flex-column justify-content-center align-items-center"
                    `,t+=`
                    data-id="${a.id}"
        ...
        `)}),$("#mockup").removeClass("d-none");return}a.length>0?(a.length===1?($("#mockup .carousel-control-next").addClass("d-none"),$("#mockup .carousel-control-prev").addClass("d-none")):($("#mockup .carousel-control-next").removeClass("d-none"),$("#mockup .carousel-control-prev").removeClass("d-none")),a.slice(0,5).forEach((n,i)=>{c.append(`
            ...
            `)}),$("#mockup").removeClass("d-none")):$("#mockup").addClass("d-none")}let C=null,v=null,S=null,k=1,j=!1,T=!1;const E=new Set;let G=!0;function D(e){G=e}function A(e){C=e.selectedJenis,v=e.category??null,S=e.type??null}function x(){return new Promise((e,o)=>{if($(window).width()<768&&$("#filter-container").addClass("d-none"),j||T)return e();j=!0,F();const t=$("#search-input").val();$.ajax({url:"/catalog",type:"GET",data:{page:k,search:t,jenis:C,category:v,type:S},success:function(a){const c=a.data.data??[],s=a.types??[];S&&($("#backButton").removeClass("d-none"),$("#homeButton").addClass("d-none")),C==3&&G?(s.length>0&&($("#search-form").addClass("d-none"),X(s,C),k++,k>a.data.last_page&&(T=!0)),M(a,!0)):(c.length>0?(z(c,C),k++,k>a.data.last_page&&(T=!0)):(k===1&&($("#mockup").addClass("d-none"),$("#product-list .row").append(`<div class="col-12"><img src="dist/img/no-data.png" alt="no-data"
                                class="img-fluid mx-auto d-block" style="max-width: 100%; height: auto; margin-top: 100px; margin-bottom: 100px;"></div>`)),T=!0),M(a,!1)),e()},error:function(){console.log("Gagal memuat data."),o()},complete:function(){j=!1,R()}})})}function M(e,o=!0){var r,n,i;const t=e.category,a=(r=e.jenis)==null?void 0:r.name,s=((i=(n=e.data.data[0])==null?void 0:n.category)==null?void 0:i.images)??[];switch(t.length===0?$("#category-container").addClass("d-none"):($("#category-container").removeClass("d-none"),s.length===0&&$("#mockup").addClass("d-none"),Q(s,C,E)),a){case"PVC Board":$("#category-container").addClass("d-none"),$(".category-modal-container").text("Tidak ada kategori");break;case"Wallboard":$("#category-menu-item-label, #category-modal-item-label").html("Motif");break;case"UV Board":$("#category-menu-item-label, #category-modal-item-label").html("Motif");break;case"Wallpanel":$("#category-menu-item-label, #category-modal-item-label").html("Motif");break;case"Aksesoris":$("#category-menu-item-label, #category-modal-item-label").html("Ukuran");break;default:$("#category-menu-item-label, #category-modal-item-label").html("Kategori")}let l='<li class="nav-item font-poppins">';Array.isArray(t)&&t.length>0?t.forEach(d=>{l+=`
            <a class="nav-link text-white category-filter d-flex align-items-center justify-content-start" 
            ...
            </a>`}):l+='<a class="nav-link text-white category-filter" href="#">Tanpa Kategori</a>',l+="</li>",o?($("#category-menu-item-label, #category-modal-item-label").html(""),$("#category-menu-item,#category-menu-item-modal").html("tidak ada kategori")):$("#category-menu-item, #category-menu-item-modal").html(l),!v&&t.length>0?(console.log("auto choose category"),v=t[0].id,H(v),N(),x()):v&&$(`.category-filter[data-id="${v}"]`).addClass("active")}function N(){k=1,j=!1,T=!1,E.clear(),$("#product-list .row").html("")}function Z(e){j=e}function aa(){return j}let I=!1;function ea(e){$(document).off("click",".category-filter"),$(document).on("click",".category-filter",async function(o){if(o.preventDefault(),I)return;I=!0;const t=$(this).data("id"),a=$(this).data("type");console.log(a);try{A({selectedJenis:e,category:t,type:a}),H(t),$("#filterModal").modal("hide"),N(),await x(!1)}catch(c){console.error("Gagal memuat data:",c)}finally{I=!1}})}$(document).ready(function(){let e=new URLSearchParams(window.location.search).get("jenis"),o=new URLSearchParams(window.location.search).get("category"),t,a;(e==5||e==2)&&sessionStorage.removeItem("selectedWallpanel"),A({selectedJenis:e,category:o}),x(),e&&($("#category-container").removeClass("d-md-none"),$("#catalog-col").removeClass("center-content")),$(window).width()<768&&$("#filter-container").addClass("d-none"),(e==1||e==3)&&($("#filter-container").addClass("d-none"),$("#catalog-col").removeClass("col-md-10"),$("#catalog-col").addClass("col-md-12")),$("#search-input").on("input",function(){clearTimeout(t),t=setTimeout(()=>{N(),x()},500)}),$(window).on("scroll",function(){clearTimeout(a),a=setTimeout(()=>{const l=$(window).scrollTop(),r=$(window).height(),n=$(document).height();if(l+r>=n-150){if(aa()===!0)return;D(!1),x().finally(()=>{Z(!1)})}},200)});function c(l,r=null,n=null){$("#carousel-product-image").empty(),$("#thumbnailGallery").empty();let i=[...l];n.toLowerCase()=="uv board"?i=[...l,...r]:i=[...l],i.forEach((p,f)=>{const b=f===0?"active":"";$("#carousel-product-image").append(`
                ...
                `),$("#thumbnailGallery").append(`
                    ...
                    `)}),l.length<=1?($("#carouselProduct .carousel-control-next").addClass("d-none"),$("#carouselProduct .carousel-control-prev").addClass("d-none")):($("#carouselProduct .carousel-control-next").removeClass("d-none"),$("#carouselProduct .carousel-control-prev").removeClass("d-none")),$("#carouselProduct").carousel({interval:3e3,pause:!1});let d;$("#thumbnailGallery").off("click").on("click",".thumbnail-image",function(){const p=$(this).data("index");$("#carouselProduct").carousel(p),$(".thumbnail-image").removeClass("active-thumbnail"),$(this).addClass("active-thumbnail"),setTimeout(()=>{$(this).removeClass("active-thumbnail")},500),$("#carouselProduct").carousel("pause"),clearTimeout(d),d=setTimeout(()=>{$("#carouselProduct").carousel("cycle")},5e3)})}$(document).on("click",".product-card",function(){const l=$(this).data("id"),r=$(this).data("code"),n=$(this).data("category"),i=$(this).attr("data-images"),d=$(this).data("type"),p=JSON.parse($(this).attr("data-paket")||"[]");let f=null,b=null;Array.isArray(p)&&(b=p.sort((y,L)=>y.order-L.order).map(y=>`/storage/${y.image}`)),i&&(f=JSON.parse(i.replace(/&quot;/g,'"')));const g=$(this).data("jenis"),m=parseInt($(this).data("length"),10),u=parseInt($(this).data("height"),10),w=parseFloat($(this).data("width")).toFixed(1),h=parseFloat($(this).data("density")).toFixed(1),P=$(this).data("url");if($("#modalPaket").empty(),g==="tipe-wallpanel"){N(),A({selectedJenis:3,type:d}),D(!1),x(),$("#filter-container").toggleClass("d-none"),$("#catalog-col").toggleClass("col-md-10 col-md-12");return}g.toLowerCase()==="uv board"&&(s(l),$("#modalVideo").hide(),$("#modalCategory").text(n),$("#modalLength").text(m&&!isNaN(m)?m+" cm":"-"),$("#modalHeight").text(u&&!isNaN(u)?u+" cm":"-"),$("#modalDensity").text(h&&!isNaN(h)?h+" mm":"-"),$("#modalKepadatan").html(`
                <span class="">0.9</span>
            `),p.length>0?p.sort((y,L)=>y.order-L.order).map(y=>{$("#modalPaket").append(`
                    ...
                    `)}):($("#modalPaket").append('<span class="text-muted">Tidak ada paket</span>'),$("#notes, .lebar").hide())),g.toLowerCase()==="wallboard"&&(s(l),$("#modalCategory").text(n),$("#modalLength").text(m&&!isNaN(m)?m+" cm":"-"),$("#modalHeight").text(u&&!isNaN(u)?u+" cm":"-"),$("#ketebalan, #kepadatan, #notes, .paket,  #modalVideo, .lebar").hide()),g==="PVC Board"&&(s(l),$("#modalCategory").text(g),$("#modalLength").text(m&&!isNaN(m)?m+" cm":"-"),$("#modalHeight").text(u&&!isNaN(u)?u+" cm":"-"),$("#modalDensity").text(h&&!isNaN(h)?h+" mm":"-"),$("#modalKepadatan").html(`
            ...
            `),$(".paket,  #modalVideo, .lebar").hide()),g==="Wallpanel"&&(s(l),$("#modalContact").data("type",d),$("#modalCategory").text(n+" / "+d),$("#ketebalan, #kepadatan, .paket, #modalVideo").hide(),$("#modalLength").text(m&&!isNaN(m)?m+" cm":"-"),$("#modalHeight").text(u&&!isNaN(u)?u+" cm":"-"),$("#modalLebar").text(w&&!isNaN(w)?w+" cm":"-")),g.toLowerCase()==="aksesoris"&&(s(l),$("#tinggi, #ketebalan, #kepadatan, .lebar").hide(),$("#paket").text("Warna"),$("#modalCategory").text(n),$("#modalPaket").append(`
            ...
            `),$("#modalLength").text("3 m"),$("#modalVideoPlayer").empty(),$("#modalVideo").hide(),P&&($("#modalVideoPlayer").append(`
