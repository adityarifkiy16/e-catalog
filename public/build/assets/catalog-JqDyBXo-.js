...
Apakah produk ini masih tersedia? Terima kasih.`,window.open(`https://wa.me/${o}?text=${encodeURIComponent(a)}`,"_blank")})}function H(){$(window).scroll(function(){$(this).scrollTop()>100?$("#btn-scroll-top").fadeIn():$("#btn-scroll-top").fadeOut()}),$("#btn-scroll-top").click(function(){return $("html, body").animate({scrollTop:0},500),!1})}function G(e,o){$("#btn-download").removeClass("d-none"),console.log(e);let n="";e.forEach(a=>{var u,h,g,v,C,y,x,k,j,L,b;const l=a.photo?`/storage/${a.photo}`:"https://via.placeholder.com/300x200?text=No+Image",c=U(a.images),m=[l,...c],d=JSON.stringify(m).replace(/"/g,"&quot;"),r=JSON.stringify(a.packages).replace(/"/g,"&quot;"),s=((u=a.category)==null?void 0:u.name)??"Tanpa Kategori";let i=a.code;o==3?i=a.code.split(" ").slice(4).join(" ").trim():o==4||o==5?i=a.code.split(" ").slice(1).join(" "):i=a.code,((h=a.category)==null?void 0:h.display_style)==="square"||o===null?n+=`
                    ...
                    `;const p=JSON.stringify(a.specifications).replace(/"/g,"&quot;");n+=`
                    data-id="${a.id}"
                    data-code="${i}"
                    data-category="${s}"
        ...
        `)}),$("#mockup").removeClass("d-none");return}l.length>0?(l.length===1?($("#mockup .carousel-control-next").addClass("d-none"),$("#mockup .carousel-control-prev").addClass("d-none"),m.addClass("d-none")):($("#mockup .carousel-control-next").removeClass("d-none"),$("#mockup .carousel-control-prev").removeClass("d-none")),l.slice(0,5).forEach((s,i)=>{c.append(`
            ...
            `)}),$("#mockup").removeClass("d-none")):$("#mockup").addClass("d-none")}let t={selectedJenis:null,category:null,type:null,currentPage:1,isLoading:!1,lastPage:!1,firstLoad:!0,currentRequest:null,uniquePaths:new Set};function _(e){t.firstLoad=e}function V(e){t.selectedJenis=e.selectedJenis,t.category=e.category??null,t.type=e.type??null}function z(){return t.isLoading}function A(){t.currentPage=1,t.isLoading=!1,t.lastPage=!1,t.uniquePaths.clear(),$("#product-list .row").html("")}function w(){if(t.isLoading||t.lastPage)return Promise.resolve();console.log("loadMoreData"),t.isLoading=!0,N();const e=$("#search-input").val();return t.currentRequest&&t.currentRequest.readyState!==4&&t.currentRequest.abort(),t.currentRequest=$.ajax({url:"/catalog",type:"GET",data:{page:t.currentPage,search:e,jenis:t.selectedJenis,category:t.category,type:t.type}}),new Promise((o,n)=>{t.currentRequest.done(a=>X(a)).fail((a,l)=>{l!=="abort"&&(console.error("Gagal memuat data."),n())}).always(()=>{t.isLoading=!1,O(),t.currentRequest=null}).then(o)})}function X(e){const o=e.data.data??[],n=e.types??[];t.type&&($("#backButton").removeClass("d-none"),$("#homeButton").addClass("d-none")),t.selectedJenis==3&&t.firstLoad?(n.length>0&&($("#search-form").addClass("d-none"),Y(n,t.selectedJenis),t.currentPage++,t.currentPage>e.data.last_page&&(t.lastPage=!0)),E(e,!0)):(o.length>0?(G(o,t.selectedJenis),t.currentPage++,t.currentPage>e.data.last_page&&(t.lastPage=!0)):(t.currentPage===1&&($("#mockup").addClass("d-none"),$("#product-list .row").append(`<div class="col-12"><img src="dist/img/no-data.png" alt="no-data"
                ...
                </a>`}):d+='<a class="nav-link text-white category-filter" href="#">Tanpa Kategori</a>',d+="</li>",o?$("#category-menu-item, #category-menu-item-modal").html("tidak ada kategori"):$("#category-menu-item, #category-menu-item-modal").html(d),!t.category&&n.length>0?(console.log("auto choose category"),t.category=n[0].id,R(t.category),A(),setTimeout(()=>{w()},200)):t.category&&$(`.category-filter[data-id="${t.category}"]`).addClass("active")}function P(e){$("#category-menu-item-label, #category-modal-item-label").html(e)}let J=!1;function Q(e){$(document).off("click",".category-filter"),$(document).on("click",".category-filter",async function(o){if(o.preventDefault(),J)return;J=!0;const n=$(this).data("id"),a=$(this).data("type");console.log(a);try{V({selectedJenis:e,category:n,type:a}),R(n),$("#filterModal").modal("hide"),A(),await w(!1)}catch(l){console.error("Gagal memuat data:",l)}finally{J=!1}})}function T(e,o="#modalVariants"){if($(o).empty(),$("#modalPaket").empty(),$("#modalKepadatan").empty(),Array.isArray(e)&&e.length>0){let n=!1,a=!1;e.forEach(l=>{const c=l.specification_values||[],m=l.name.toLowerCase();if(m==="warna")n=!0,$("#paket").text("Warna"),c.length>0?c.forEach(d=>{l.pivot&&d.id===l.pivot.specification_value_id&&$("#modalPaket").append(`
                                <span class="badge badge-outline-primary px-2 py-1 kepadatan" data-value="${d.name}">
                                    ${d.name}
                                </span>
                            `)}):$("#modalPaket").append('<span class="text-muted">Tidak ada data</span>');else if(m==="density")a=!0,c.length>0?c.forEach(d=>{l.pivot&&d.id===l.pivot.specification_value_id&&(c.length>1?$("#modalKepadatan").append(`
                                    <span class="badge badge-outline-primary px-2 py-1 kepadatan" data-value="${d.name}">
                                        ${d.name}
                                    </span>
                ...
                `;$(o).append(i)}}),!n&&!a?($(".paket").hide(),$(".density").hide()):($(".paket").show(),$(".density").show())}else $(o).append('<div class="text-muted">Tidak ada varian</div>'),$(".paket").hide()}function K(e=null){$(window).width()<768?$("#filter-container").addClass("d-none"):$("#filter-container").removeClass("d-none"),(e==1||e==3)&&($("#filter-container").addClass("d-none"),$("#catalog-col").removeClass("col-md-10").addClass("col-md-12"))}$(document).ready(function(){const e=new URLSearchParams(window.location.search),o=e.get("jenis"),n=e.get("category");let a,l,c=!1;(o==5||o==2)&&sessionStorage.removeItem("selectedWallpanel"),V({selectedJenis:o,category:n}),w(),o&&($("#category-container").removeClass("d-md-none"),$("#catalog-col").removeClass("center-content")),K(o),$(window).on("resize",()=>K(o)),$("#search-input").on("input",function(){clearTimeout(a),a=setTimeout(()=>{A(),w()},500)}),$(window).on("scroll",function(){clearTimeout(l),l=setTimeout(async()=>{if(c||z())return;const r=$(window).scrollTop(),s=$(window).height(),i=$(document).height();if(r+s>=i-150){c=!0;try{_(!1),await w()}finally{c=!1}}},200)});function m(r,s=[],i=""){$("#carousel-product-image").empty(),$("#thumbnailGallery").empty();let p=r||[];(i==null?void 0:i.toLowerCase())==="uv board"&&s.length&&(p=[...r,...s]),p.forEach((h,g)=>{const v=g===0?"active":"";$("#carousel-product-image").append(`
            ...
            `)}),p.length<=1?$("#carouselProduct .carousel-control-next, #carouselProduct .carousel-control-prev").addClass("d-none"):$("#carouselProduct .carousel-control-next, #carouselProduct .carousel-control-prev").removeClass("d-none"),$("#carouselProduct").carousel({interval:3e3,pause:!1});let u;$("#thumbnailGallery").off("click").on("click",".thumbnail-image",function(){const h=$(this).data("index");$("#carouselProduct").carousel(h),$(".thumbnail-image").removeClass("active-thumbnail"),$(this).addClass("active-thumbnail"),setTimeout(()=>$(this).removeClass("active-thumbnail"),500),$("#carouselProduct").carousel("pause"),clearTimeout(u),u=setTimeout(()=>{$("#carouselProduct").carousel("cycle")},5e3)})}$(document).on("click",".product-card",function(){const r=$(this).data("id");console.log("productId",r);const s=$(this).data("code"),i=$(this).data("category"),p=$(this).data("type"),u=$(this).data("jenis"),h=parseInt($(this).data("length"),10),g=parseFloat($(this).data("width")).toFixed(1),v=parseFloat($(this).data("density")).toFixed(1),C=$(this).data("url"),y=JSON.parse($(this).attr("data-specifications")||"[]"),x=$(this).attr("data-images"),k=JSON.parse($(this).attr("data-paket")||"[]");let j=$(this).data("height"),L=$(this).data("type-image"),b=[],q=[];if(x)try{b=JSON.parse(x.replace(/&quot;/g,'"'))}catch{b=[]}if(Array.isArray(k)&&(q=k.sort((f,I)=>f.order-I.order).map(f=>`/storage/${f.image}`)),$("#modalPaket").empty(),u==="tipe-wallpanel"){A(),V({selectedJenis:3,type:p}),_(!1),w(),K(),$("#catalog-col").toggleClass("col-md-10 col-md-12");return}u.toLowerCase()==="uv board"&&(d(r),T(y),$("#modalVideo, .lebar").hide(),$("#modalCategory").text(i),k.length>0?k.sort((f,I)=>f.order-I.order).map(f=>{$("#modalPaket").append(`
                        <span class="badge badge-outline-primary px-2 py-1 kepadatan" data-value="${f.name}">${f.name}</span>
                    `)}):($("#modalPaket").append('<span class="text-muted">Tidak ada paket</span>'),$("#notes").hide())),u.toLowerCase()==="wallboard"&&(d(r),T(y),$("#modalCategory").text(i),$("#ketebalan, .density, #notes, .paket,  #modalVideo, .lebar").hide()),u==="PVC Board"&&(d(r),T(y),$("#modalCategory").text(u),$("#modalVideo, .lebar, .paket").hide()),u==="Wallpanel"&&(d(r),T(y),$("#modalContact").data("type",p),$("#modalCategory").text(i+" / "+p),$("#ketebalan, #kepadatan, .paket, #modalVideo, #notes, .density").hide(),$("#modalGrafis").attr("src",`/storage/${L}`),$(".grafis").removeClass("d-none")),u.toLowerCase()==="aksesoris"&&(d(r),$("#tinggi, #ketebalan, #kepadatan, .lebar, .density").hide(),$("#modalCategory").text(i),T(y),$("#modalVideoPlayer").empty(),$("#modalVideo, .density").hide(),C&&($("#modalVideoPlayer").append(`
