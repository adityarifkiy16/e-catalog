...
Apakah produk ini masih tersedia? Terima kasih.`,window.open(`https://wa.me/${o}?text=${encodeURIComponent(a)}`,"_blank")})}function W(){$(window).scroll(function(){$(this).scrollTop()>100?$("#btn-scroll-top").fadeIn():$("#btn-scroll-top").fadeOut()}),$("#btn-scroll-top").click(function(){return $("html, body").animate({scrollTop:0},500),!1})}function q(e,o){let t="";e.forEach(a=>{var d,c,u,p,f,w,k,C,x;const r=a.photo?`/storage/${a.photo}`:"https://via.placeholder.com/300x200?text=No+Image",n=U(a.images),l=[r,...n],s=JSON.stringify(l).replace(/"/g,"&quot;"),i=((d=a.category)==null?void 0:d.name)??"Tanpa Kategori";let m=a.code;o==3?m=a.code.split(" ").slice(4).join(" ").trim():o==5?m=a.code.split(" ").slice(1).join(" "):m=a.code,((c=a.category)==null?void 0:c.display_style)==="square"||o===null?t+=`
            ...
            `)}),$("#mockup").removeClass("d-none");return}a.length>0?(a.length===1?($("#mockup .carousel-control-next").addClass("d-none"),$("#mockup .carousel-control-prev").addClass("d-none")):($("#mockup .carousel-control-next").removeClass("d-none"),$("#mockup .carousel-control-prev").removeClass("d-none")),a.slice(0,5).forEach((s,i)=>{r.append(`
                    ...
                    `)}),$("#mockup").removeClass("d-none")):$("#mockup").addClass("d-none")}let y=null,g=null,L=null,h=1,j=!1,v=!1;const S=new Set;let V=!0;function M(e){V=e}function N(e){y=e.selectedJenis,g=e.category??null,L=e.type??null}function b(){return new Promise((e,o)=>{if($(window).width()<768&&$("#filter-container").addClass("d-none"),!g||g==="null"||g===""?$("#btn-download").addClass("d-none"):$("#btn-download").removeClass("d-none"),j||v)return e();j=!0,_();const t=$("#search-input").val();$.ajax({url:"/catalog",type:"GET",data:{page:h,search:t,jenis:y,category:g,type:L},success:function(a){const r=a.data.data??[],n=a.types??[];$("#btn-download").addClass("d-none"),L&&($("#btn-download").removeClass("d-none"),$("#backButton").removeClass("d-none"),$("#homeButton").addClass("d-none")),y==3&&V?(n.length>0&&(F(n,y),h++,h>a.data.last_page&&(v=!0)),A(a,!0)):($("#btn-download").removeClass("d-none"),r.length>0?(q(r,y),h++,h>a.data.last_page&&(v=!0)):(h===1&&($("#mockup").addClass("d-none"),$("#product-list .row").append(`<div class="col-12"><img src="dist/img/no-data.png" alt="no-data"
                                class="img-fluid mx-auto d-block" style="max-width: 100%; height: auto; margin-top: 100px; margin-bottom: 100px;"></div>`)),v=!0),A(a,!1)),e()},error:function(){console.log("Gagal memuat data."),o()},complete:function(){j=!1,G()}})})}function A(e,o=!0){var s,i,m;const t=e.category,a=(s=e.jenis)==null?void 0:s.name,n=((m=(i=e.data.data[0])==null?void 0:i.category)==null?void 0:m.images)??[];switch(t.length===0?$("#category-container").addClass("d-none"):($("#category-container").removeClass("d-none"),n.length===0&&$("#mockup").addClass("d-none"),J(n,y,S)),a){case"PVC Board":$("#category-container").addClass("d-none"),$(".category-modal-container").text("Tidak ada kategori");break;case"Wallboard":$("#category-menu-item-label, #category-modal-item-label").html("Motif");break;case"UV Board":$("#category-menu-item-label, #category-modal-item-label").html("Motif");break;case"Wallpanel":$("#category-menu-item-label, #category-modal-item-label").html("Motif");break;case"Aksesoris":$("#category-container").addClass("d-none"),$(".category-modal-container").text("Tidak ada kategori");break;default:$("#category-menu-item-label, #category-modal-item-label").html("Kategori")}let l='<li class="nav-item font-poppins">';Array.isArray(t)&&t.length>0?t.forEach(d=>{l+=`
