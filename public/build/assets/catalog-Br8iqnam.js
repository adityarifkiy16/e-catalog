...
Apakah produk ini masih tersedia? Terima kasih.`,window.open(`https://wa.me/${o}?text=${encodeURIComponent(a)}`,"_blank")})}function Y(){$(window).scroll(function(){$(this).scrollTop()>100?$("#btn-scroll-top").fadeIn():$("#btn-scroll-top").fadeOut()}),$("#btn-scroll-top").click(function(){return $("html, body").animate({scrollTop:0},500),!1})}function z(e,o){$("#btn-download").removeClass("d-none");let t="";e.forEach(a=>{var p,f,b,g,u,i,w,h,P;const m=a.photo?`/storage/${a.photo}`:"https://via.placeholder.com/300x200?text=No+Image",d=W(a.images),l=[m,...d],c=JSON.stringify(l).replace(/"/g,"&quot;"),n=JSON.stringify(a.packages).replace(/"/g,"&quot;"),s=((p=a.category)==null?void 0:p.name)??"Tanpa Kategori";let r=a.code;o==3?r=a.code.split(" ").slice(4).join(" ").trim():o==5?r=a.code.split(" ").slice(1).join(" "):r=a.code,((f=a.category)==null?void 0:f.display_style)==="square"||o===null?t+=`
                ...
                </div>`}),$("#product-list .row").append(t)}function X(e,o){$("#btn-download").addClass("d-none");let t="";e.forEach(a=>{const m=a.thumbnail?`/storage/${a.thumbnail}`:"https://via.placeholder.com/300x200?text=No+Image";console.log(o);const d=o==3?"wallpanel":"tanpa kategori";t+=`
                    <div class="col-md-2 col-6 mb-4">
                        <div class="h-100 product-card d-flex flex-column justify-content-center align-items-center"
                    `,t+=`
                    data-id="${a.id}"
        ...
        `)}),$("#mockup").removeClass("d-none");return}a.length>0?(a.length===1?($("#mockup .carousel-control-next").addClass("d-none"),$("#mockup .carousel-control-prev").addClass("d-none")):($("#mockup .carousel-control-next").removeClass("d-none"),$("#mockup .carousel-control-prev").removeClass("d-none")),a.slice(0,5).forEach((n,s)=>{m.append(`
            ...
            `)}),$("#mockup").removeClass("d-none")):$("#mockup").addClass("d-none")}let C=null,v=null,S=null,k=1,j=!1,T=!1;const E=new Set;let F=!0;function D(e){F=e}function A(e){C=e.selectedJenis,v=e.category??null,S=e.type??null}function x(){return new Promise((e,o)=>{if($(window).width()<768&&$("#filter-container").addClass("d-none"),j||T)return e();j=!0,_();const t=$("#search-input").val();$.ajax({url:"/catalog",type:"GET",data:{page:k,search:t,jenis:C,category:v,type:S},success:function(a){const m=a.data.data??[],d=a.types??[];S&&($("#backButton").removeClass("d-none"),$("#homeButton").addClass("d-none")),C==3&&F?(d.length>0&&($("#search-form").addClass("d-none"),X(d,C),k++,k>a.data.last_page&&(T=!0)),M(a,!0)):(m.length>0?(z(m,C),k++,k>a.data.last_page&&(T=!0)):(k===1&&($("#mockup").addClass("d-none"),$("#product-list .row").append(`<div class="col-12"><img src="dist/img/no-data.png" alt="no-data"
                                class="img-fluid mx-auto d-block" style="max-width: 100%; height: auto; margin-top: 100px; margin-bottom: 100px;"></div>`)),T=!0),M(a,!1)),e()},error:function(){console.log("Gagal memuat data."),o()},complete:function(){j=!1,R()}})})}function M(e,o=!0){var c,n,s;const t=e.category,a=(c=e.jenis)==null?void 0:c.name,d=((s=(n=e.data.data[0])==null?void 0:n.category)==null?void 0:s.images)??[];switch(t.length===0?$("#category-container").addClass("d-none"):($("#category-container").removeClass("d-none"),d.length===0&&$("#mockup").addClass("d-none"),Q(d,C,E)),a){case"PVC Board":$("#category-container").addClass("d-none"),$(".category-modal-container").text("Tidak ada kategori");break;case"Wallboard":$("#category-menu-item-label, #category-modal-item-label").html("Motif");break;case"UV Board":$("#category-menu-item-label, #category-modal-item-label").html("Motif");break;case"Wallpanel":$("#category-menu-item-label, #category-modal-item-label").html("Motif");break;case"Aksesoris":$("#category-menu-item-label, #category-modal-item-label").html("Ukuran");break;default:$("#category-menu-item-label, #category-modal-item-label").html("Kategori")}let l='<li class="nav-item font-poppins">';Array.isArray(t)&&t.length>0?t.forEach(r=>{l+=`
