...
Apakah produk ini masih tersedia? Terima kasih.`,window.open(`https://wa.me/${o}?text=${encodeURIComponent(a)}`,"_blank")})}function W(){$(window).scroll(function(){$(this).scrollTop()>100?$("#btn-scroll-top").fadeIn():$("#btn-scroll-top").fadeOut()}),$("#btn-scroll-top").click(function(){return $("html, body").animate({scrollTop:0},500),!1})}function q(e,o){$("#btn-download").removeClass("d-none");let t="";e.forEach(a=>{var g,c,u,p,y,C,v,x,j;const r=a.photo?`/storage/${a.photo}`:"https://via.placeholder.com/300x200?text=No+Image",n=G(a.images),i=[r,...n],s=JSON.stringify(i).replace(/"/g,"&quot;"),d=JSON.stringify(a.packages).replace(/"/g,"&quot;"),m=((g=a.category)==null?void 0:g.name)??"Tanpa Kategori";let l=a.code;o==3?l=a.code.split(" ").slice(4).join(" ").trim():o==5?l=a.code.split(" ").slice(1).join(" "):l=a.code,((c=a.category)==null?void 0:c.display_style)==="square"||o===null?t+=`
                ...
                </div>`}),$("#product-list .row").append(t)}function Y(e,o){$("#btn-download").addClass("d-none");let t="";e.forEach(a=>{const r=a.thumbnail?`/storage/${a.thumbnail}`:"https://via.placeholder.com/300x200?text=No+Image";console.log(o);const n=o==3?"wallpanel":"tanpa kategori";t+=`
                    <div class="col-md-2 col-6 mb-4">
                        <div class="h-100 product-card d-flex flex-column justify-content-center align-items-center"
                    `,t+=`
                    data-id="${a.id}"
                ...
                </div>`}),$("#product-list .row").append(t)}function F(e,o,t){if(o==null)return;e.forEach(s=>{s.path&&t.add(s.path)});const a=Array.from(t),r=$("#mockup-carousel-inner"),n=$("#mockup-carousel-indicators"),i=["https://www.youtube.com/embed/BiiUrYAbL9s?autoplay=1&mute=1&rel=0&controls=0&amp;loop=1&playlist=BiiUrYAbL9s"];if(r.empty(),n.empty(),o==4){$("#mockup-carousel").carousel({interval:!1}),$("#mockup .carousel-control-next").addClass("d-none"),$("#mockup .carousel-control-prev").addClass("d-none"),i.forEach((s,d)=>{r.append(`
        ...
        `)}),$("#mockup").removeClass("d-none");return}a.length>0?(a.length===1?($("#mockup .carousel-control-next").addClass("d-none"),$("#mockup .carousel-control-prev").addClass("d-none")):($("#mockup .carousel-control-next").removeClass("d-none"),$("#mockup .carousel-control-prev").removeClass("d-none")),a.slice(0,5).forEach((s,d)=>{r.append(`
            ...
            `)}),$("#mockup").removeClass("d-none")):$("#mockup").addClass("d-none")}let b=null,f=null,I=null,h=1,P=!1,w=!1;const H=new Set;let _=!0;function M(e){_=e}function A(e){b=e.selectedJenis,f=e.category??null,I=e.type??null}function k(){return new Promise((e,o)=>{if($(window).width()<768&&$("#filter-container").addClass("d-none"),P||w)return e();P=!0,U();const t=$("#search-input").val();$.ajax({url:"/catalog",type:"GET",data:{page:h,search:t,jenis:b,category:f,type:I},success:function(a){const r=a.data.data??[],n=a.types??[];I&&($("#backButton").removeClass("d-none"),$("#homeButton").addClass("d-none")),b==3&&_?(n.length>0&&(Y(n,b),h++,h>a.data.last_page&&(w=!0)),V(a,!0)):(r.length>0?(q(r,b),h++,h>a.data.last_page&&(w=!0)):(h===1&&($("#mockup").addClass("d-none"),$("#product-list .row").append(`<div class="col-12"><img src="dist/img/no-data.png" alt="no-data"
                                class="img-fluid mx-auto d-block" style="max-width: 100%; height: auto; margin-top: 100px; margin-bottom: 100px;"></div>`)),w=!0),V(a,!1)),e()},error:function(){console.log("Gagal memuat data."),o()},complete:function(){P=!1,O()}})})}function V(e,o=!0){var s,d,m;const t=e.category,a=(s=e.jenis)==null?void 0:s.name,n=((m=(d=e.data.data[0])==null?void 0:d.category)==null?void 0:m.images)??[];switch(t.length===0?$("#category-container").addClass("d-none"):($("#category-container").removeClass("d-none"),n.length===0&&$("#mockup").addClass("d-none"),F(n,b,H)),a){case"PVC Board":$("#category-container").addClass("d-none"),$(".category-modal-container").text("Tidak ada kategori");break;case"Wallboard":$("#category-menu-item-label, #category-modal-item-label").html("Motif");break;case"UV Board":$("#category-menu-item-label, #category-modal-item-label").html("Motif");break;case"Wallpanel":$("#category-menu-item-label, #category-modal-item-label").html("Motif");break;case"Aksesoris":$("#category-container").addClass("d-none"),$(".category-modal-container").text("Tidak ada kategori");break;default:$("#category-menu-item-label, #category-modal-item-label").html("Kategori")}let i='<li class="nav-item font-poppins">';Array.isArray(t)&&t.length>0?t.forEach(l=>{i+=`
            <a class="nav-link text-white category-filter d-flex align-items-center justify-content-start" 
                ...
                `),$("#thumbnailGallery").append(`
                    ...
                    `)}),n.length<=1?($("#carouselProduct .carousel-control-next").addClass("d-none"),$("#carouselProduct .carousel-control-prev").addClass("d-none")):($("#carouselProduct .carousel-control-next").removeClass("d-none"),$("#carouselProduct .carousel-control-prev").removeClass("d-none")),$("#carouselProduct").carousel({interval:3e3,pause:!1});let m;$("#thumbnailGallery").off("click").on("click",".thumbnail-image",function(){const l=$(this).data("index");$("#carouselProduct").carousel(l),$(".thumbnail-image").removeClass("active-thumbnail"),$(this).addClass("active-thumbnail"),setTimeout(()=>{$(this).removeClass("active-thumbnail")},500),$("#carouselProduct").carousel("pause"),clearTimeout(m),m=setTimeout(()=>{$("#carouselProduct").carousel("cycle")},5e3)})}$(document).on("click",".product-card",function(){const n=$(this).data("code"),i=$(this).data("category"),s=$(this).attr("data-images"),d=$(this).data("type"),m=JSON.parse($(this).attr("data-paket"));let l=null,g=null;Array.isArray(m)&&(g=m.map(T=>`/storage/${T.image}`)),s&&(l=JSON.parse(s.replace(/&quot;/g,'"')));const c=$(this).data("jenis"),u=parseInt($(this).data("length"),10),p=parseInt($(this).data("height"),10),y=parseInt($(this).data("density"),10),C=$(this).data("id"),v=$(this).data("url");if($("#modalPaket").empty(),c==="tipe-wallpanel"){L(),A({selectedJenis:3,type:d}),M(!1),k(),$("#filter-container").toggleClass("d-none"),$("#catalog-col").toggleClass("col-md-10 col-md-12");return}c.toLowerCase()==="uv board"&&($("#ketebalan, #kepadatan,  #modalVideo").hide(),$("#modalCategory").text(i),$("#modalLength").text(u&&!isNaN(u)?u+" cm":"-"),$("#modalHeight").text(p&&!isNaN(p)?p+" cm":"-"),m.map(T=>{$("#modalPaket").append(`
            ...
            `),$(".paket,  #modalVideo").hide()),c==="Wallpanel"&&($("#modalContact").data("type",d),$("#modalCategory").text(i+" / "+d),$("#panjang, #tinggi, #ketebalan, #kepadatan, #notes, .paket, #modalVideo").hide()),c.toLowerCase()==="aksesoris"&&($("#panjang, #tinggi, #ketebalan, #kepadatan, #notes, .paket").hide(),$("#modalCategory").text(i),$("#modalVideoPlayer").empty(),$("#modalVideo").hide(),v&&($("#modalVideoPlayer").append(`
                ...
                `),$("#modalVideo").show())),r(l,g,c),$("#modalCode").text(n),$("#productModalLabel").text(n),$("#modalDownload").data("id",C),$("#productModal").modal("show"),$("#modalContact").data("jenis",c),$("#modalContact").data("category",i),$("#modalContact").data("code",n);let x=$("#modalContact").data("kepadatan"),j=$("#modalContact").data("paket");x&&($(".kepadatan").removeClass("active"),$("#modalContact").data("kepadatan",null),$("#notes").show()),j&&($(".kepadatan").removeClass("active"),$("#modalContact").data("kepadatan",null),$("#notes").show());let S=$(".kepadatan");console.log(S.length),S.length>0&&$(".modalContact").prop("disabled",!0)}),$(document).on("click",".kepadatan",function(){$(".modalContact").prop("disabled",!1);let n=$(this).data("value");$(this).closest("#productModal").find(".kepadatan").removeClass("active"),$(this).addClass("active"),$("#notes").hide(),$("#modalContact").data("kepadatan",n)}),z(e),J(),R(),W()});
