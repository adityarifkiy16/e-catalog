...
Apakah produk ini masih tersedia? Terima kasih.`,window.open(`https://wa.me/${o}?text=${encodeURIComponent(a)}`,"_blank")})}function U(){$(window).scroll(function(){$(this).scrollTop()>100?$("#btn-scroll-top").fadeIn():$("#btn-scroll-top").fadeOut()}),$("#btn-scroll-top").click(function(){return $("html, body").animate({scrollTop:0},500),!1})}function W(e,o){let t="";e.forEach(a=>{var s,r,u,g,f,v,w,C,x;const i=a.photo?`/storage/${a.photo}`:"https://via.placeholder.com/300x200?text=No+Image",n=H(a.images),l=[i,...n],c=JSON.stringify(l).replace(/"/g,"&quot;"),m=((s=a.category)==null?void 0:s.name)??"Tanpa Kategori";let d=a.code;o==3?d=a.code.split(" ").slice(4).join(" ").trim():o==5?d=a.code.split(" ").slice(1).join(" "):d=a.code,((r=a.category)==null?void 0:r.display_style)==="square"||o===null?t+=`
                ...
                </div>`}),$("#product-list .row").append(t)}function O(e,o){let t="";e.forEach(a=>{const i=a.thumbnail?`/storage/${a.thumbnail}`:"https://via.placeholder.com/300x200?text=No+Image";console.log(o);const n=o==3?"wallpanel":"tanpa kategori";t+=`
                    <div class="col-md-2 col-6 mb-4">
                        <div class="h-100 product-card d-flex flex-column justify-content-center align-items-center"
                    `,t+=`
                    data-id="${a.id}"
                    ...
                    `)}),$("#mockup").removeClass("d-none")):$("#mockup").addClass("d-none")}let y=null,p=null,A=null,h=1,j=!1,b=!1;const D=new Set;function L(e){y=e.selectedJenis,p=e.category??null,A=e.type??null}function k(e=!0){return new Promise((o,t)=>{if($(window).width()<768&&$("#filter-container").addClass("d-none"),!p||p==="null"||p===""?$("#btn-download").addClass("d-none"):$("#btn-download").removeClass("d-none"),j||b)return o();j=!0,B();const a=$("#search-input").val();$.ajax({url:"/catalog",type:"GET",data:{page:h,search:a,jenis:y,category:p,type:A},success:function(i){console.log("Data berhasil dimuat."),console.log(i);const n=i.data.data??[],l=i.types??[];y==3&&e?(console.log("isFirstLoad:"+e),l.length>0&&(O(l,y),h++,h>i.data.last_page&&(b=!0)),T(i,!0)):(console.log("isFirstLoad:"+e),n.length>0?(W(n,y),h++,h>i.data.last_page&&(b=!0)):(h===1&&($("#mockup").addClass("d-none"),$("#product-list .row").append(`<div class="col-12"><img src="dist/img/no-data.png" alt="no-data"
                                class="img-fluid mx-auto d-block" style="max-width: 100%; height: auto; margin-top: 100px; margin-bottom: 100px;"></div>`)),b=!0),T(i,!1)),T(i,!1),o()},error:function(){console.log("Gagal memuat data."),t()},complete:function(){j=!1,E()}})})}function T(e,o=!0){var c,m,d;const t=e.category,a=(c=e.jenis)==null?void 0:c.name,n=((d=(m=e.data.data[0])==null?void 0:m.category)==null?void 0:d.images)??[];switch(t.length===0?$("#category-container").addClass("d-none"):($("#category-container").removeClass("d-none"),n.length===0&&$("#mockup").addClass("d-none"),R(n,y,D)),a){case"PVC Board":$("#category-container, #category-modal-container").addClass("d-none");break;case"Wallboard":case"UV Board":$("#category-menu-item-label, #category-modal-item-label").html("Motif");break;case"Wallpanel":break;case"Aksesoris":$("#category-container, #category-modal-container").addClass("d-none");break;default:$("#category-menu-item-label, #category-modal-item-label").html("Kategori")}let l='<li class="nav-item font-poppins">';Array.isArray(t)&&t.length>0?t.forEach(s=>{l+=`
