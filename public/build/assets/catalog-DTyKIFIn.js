...
Apakah produk ini masih tersedia? Terima kasih.`;window.open(`https://wa.me/${o}?text=${encodeURIComponent(t)}`,"_blank")})}function L(){$(window).scroll(function(){$(this).scrollTop()>100?$("#btn-scroll-top").fadeIn():$("#btn-scroll-top").fadeOut()}),$("#btn-scroll-top").click(function(){return $("html, body").animate({scrollTop:0},500),!1})}function G(e,o){let t="";e.forEach(a=>{var y,b,v,w,C,x,k;const n=a.photo?`/storage/${a.photo}`:"https://via.placeholder.com/300x200?text=No+Image",l=B(a.images),i=[n,...l],c=JSON.stringify(i).replace(/"/g,"&quot;"),h=((y=a.category)==null?void 0:y.name)??"Tanpa Kategori";((b=a.category)==null?void 0:b.display_style)==="square"||o===null?t+=`
                    ...
                    `)}),$("#mockup").removeClass("d-none")):$("#mockup").addClass("d-none")}let g=null,s=null,d=1,u=!1,m=!1;const I=new Set;function D(e){g=e.selectedJenis,s=e.category??null}function r(){return new Promise((e,o)=>{if(!s||s==="null"||s===""?$("#btn-download").addClass("d-none"):$("#btn-download").removeClass("d-none"),u||m)return e();u=!0,S();const t=$("#search-input").val();$.ajax({url:"/catalog",type:"GET",data:{page:d,search:t,jenis:g,category:s},success:function(a){const n=a.data.data??[];n.length>0?(G(n,g),d++,d>a.data.last_page&&(m=!0)):(d===1&&($("#mockup").addClass("d-none"),$("#product-list .row").append(`<div class="col-12"><img src="dist/img/no-data.png" alt="no-data"
                                class="img-fluid mx-auto d-block" style="max-width: 100%; height: auto; margin-top: 100px; margin-bottom: 100px;"></div>`)),m=!0),O(a),e()},error:function(){console.log("Gagal memuat data."),o()},complete:function(){u=!1,_()}})})}function O(e){var l,i;const o=((l=e.jenis)==null?void 0:l.categories)??[],t=(i=e.jenis)==null?void 0:i.name,a=e;switch(o.length===0?$("#category-container").addClass("d-none"):$("#category-container").removeClass("d-none"),s&&(a.category.images.length===0&&$("#mockup").addClass("d-none"),U(a.category.images,g,I)),t){case"PVC Board":$("#category-container, #category-modal-container").addClass("d-none");break;case"Wallboard":case"UV Board":$("#category-menu-item-label, #category-modal-item-label").html("Motif");break;case"Wallpanel":$("#category-container, #category-modal-container").addClass("d-none");break;default:$("#category-menu-item-label, #category-modal-item-label").html("Kategori")}let n='<li class="nav-item font-poppins">';o.forEach(c=>{n+=`
