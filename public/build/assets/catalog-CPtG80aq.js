let I=null;function M(e){I=e}function D(){return I}function L(){$("#loading").removeClass("d-none")}function B(){$("#loading").addClass("d-none")}function J(e){return e.slice().sort((i,a)=>i.pivot.motif&&!a.pivot.motif?-1:!i.pivot.motif&&a.pivot.motif?1:0).map(i=>"/storage/"+i.path)}function W(){$(document).on("click",".modalDownload",function(e){e.preventDefault();const i=$(this).data("id"),a="catalog/pdf/product?id="+encodeURIComponent(i);P(this,a)}),$("#btn-download").on("click",function(e){e.preventDefault(),P(this,"catalog/pdf?category="+encodeURIComponent(D()))})}function P(e,i){const a=$(e);a.prop("disabled",!0).html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Mengunduh...'),window.open(i,"_blank"),setTimeout(()=>{a.prop("disabled",!1).html('<i class="fa fa-file-download"></i> Download')},5e3)}function _(){$(document).on("click",".modalContact",function(e){e.preventDefault(),console.log("Klik tombol order",$(this).data("code"));const i="62816659688";let a="";$(this).data("wallpanel")?a=`Halo Admin,
